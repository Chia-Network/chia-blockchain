...
_run_bg_cmd python -m src.server.start_full_node "127.0.0.1" 8444 -id 1 -f -t -u 8222 -r 9444
_run_bg_cmd python -m src.server.start_full_node "127.0.0.1" 8002 -id 2 -u 8223 -r 9445
