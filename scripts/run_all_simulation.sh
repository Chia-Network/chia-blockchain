...
_run_bg_cmd python -m src.server.start_full_node 8444 -id 1 -f -t -u 8222
_run_bg_cmd python -m src.server.start_full_node 8002 -id 2 -u 8223
_run_bg_cmd python -m src.server.start_full_node 8005 -id 3 -u 8224
