...
Chia is a modern cryptocurrency built from scratch, designed to be simple, decentralized, and secure. Here are some of
the features and benefits:
* [Proof of space and time](https://docs.google.com/document/d/1tmRIb7lgi4QfKkNaxuKOBHRmwbVlGL4f7EsBDr_5xZE/edit) based consensus which allows anyone to farm with commodity hardware
* Very easy to use full node and farmer GUI and cli (thousands of nodes active on mainnet)
* Simplified UTXO based transaction model, with small on chain state
* Lisp-style turing complete functional [programming language](https://www.chia.net/2019/11/27/chialisp.en.html) for money related use cases
* BLS keys and aggregate signatures (only one signature per block)
* Pooling [protocol](https://www.chia.net/2020/11/10/pools-in-chia.html) that allows farmers to have control of making blocks
* Support for light clients with fast O(log(N)) syncing
