...
from flange.cmds.init_funcs import check_keys
from flange.consensus.block_rewards import calculate_base_farmer_reward
from flange.pools.pool_wallet import PoolWallet
from flange.pools.pool_wallet_info import create_pool_state, FARMING_TO_POOL, PoolWalletInfo, PoolState
from flange.protocols.protocol_message_types import ProtocolMessageTypes
from flange.server.outbound_message import NodeType, make_msg
from flange.simulator.simulator_protocol import FarmNewBlockProtocol
...
from flange.util.keychain import bytes_to_mnemonic, generate_mnemonic
from flange.util.path import path_from_root
from flange.util.ws_message import WsRpcMessage, create_payload_dict
from flange.wallet.cc_wallet.cc_wallet import CCWallet
from flange.wallet.derive_keys import master_sk_to_singleton_owner_sk
from flange.wallet.rl_wallet.rl_wallet import RLWallet
from flange.wallet.derive_keys import master_sk_to_farmer_sk, master_sk_to_pool_sk, master_sk_to_wallet_sk
from flange.wallet.did_wallet.did_wallet import DIDWallet
from flange.wallet.trade_record import TradeRecord
from flange.wallet.transaction_record import TransactionRecord
from flange.wallet.util.backup_utils import download_backup, get_backup_info, upload_backup
from flange.wallet.util.trade_utils import trade_record_to_dict
from flange.wallet.util.transaction_type import TransactionType
from flange.wallet.util.wallet_types import WalletType
from flange.wallet.wallet_info import WalletInfo
from flange.wallet.wallet_node import WalletNode
from flange.util.config import load_config
...
class WalletRpcApi:
    def __init__(self, wallet_node: WalletNode):
        ...
        self.service_name = "flange_wallet"
    ...
    async def _state_changed(self, *args) -> List[WsRpcMessage]:
        ...
        return [create_payload_dict("state_changed", data, "flange_wallet", "wallet_ui")]
    ...
    async def create_new_wallet(self, request: Dict):
        ...
        if request["wallet_type"] == "cc_wallet":
            ...
            if request["mode"] == "new":
                ...
                from flange.pools.pool_wallet_info import initial_pool_state_from_dict
