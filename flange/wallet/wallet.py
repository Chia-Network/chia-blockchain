...
from flange.wallet.puzzles.puzzle_utils import (
...
from flange.wallet.secret_key_store import SecretKeyStore
from flange.wallet.sign_coin_spends import sign_coin_spends
...
class Wallet:
    ...
    async def create_spend_bundle_relative_flange(self, flange_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if flange_amount < 0:
            utxos = await self.select_coins(abs(flange_amount), exclude)
        else:
        ...
        flange_amount = spend_value + flange_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": flange_amount}]
