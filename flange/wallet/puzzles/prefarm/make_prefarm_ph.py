...
def make_puzzle(amount: int) -> int:
    ...
    if error:
        ...
        for cvp in result_human:
            ...
            total_flange += int_from_bytes(cvp.vars[1])
            print(
...
total_flange = 0
print("Pool address: ")
total_flange += make_puzzle(pool_amounts)
print("\nFarmer address: ")
total_flange += make_puzzle(farmer_amounts)

assert total_flange == calculate_base_farmer_reward(uint32(0)) + calculate_pool_reward(uint32(0))
