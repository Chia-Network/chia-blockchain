import click
# from flange.util.keychain import supports_keyring_passphrase
...
#   from flange.cmds.passphrase_funcs import initialize_passphrase
...
#    from flange.cmds.passphrase_funcs import remove_passphrase_options_from_cmd
