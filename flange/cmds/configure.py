...
from flange.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "58444"
            testnet_introducer = "introducer.flangecoin.io"
            testnet = "testnet7"
            ...
            mainnet_port = "8444"
            mainnet_introducer = "introducer.flangecoin.io"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running flange services for changes to take effect")
