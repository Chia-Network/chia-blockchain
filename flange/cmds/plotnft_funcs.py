...
from flange.cmds.wallet_funcs import print_balance, wallet_coin_unit
from flange.pools.pool_wallet_info import PoolWalletInfo, PoolSingletonState
from flange.protocols.pool_protocol import POOL_PROTOCOL_VERSION
        ...
        try:
            ...
            while time.time() - start < 10:
                ...
                if len(tx.sent_to) > 0:
                    ...
                    print(f"Do flange wallet get_transaction -f {fingerprint} -tx 0x{tx_record.name} to get status")
                    return None
        except Exception as e:
