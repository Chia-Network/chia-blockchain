...
from flange.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from flange.harvester.harvester import Harvester
from flange.plotting.plot_tools import PlotInfo, parse_plot_info
from flange.protocols import harvester_protocol
from flange.protocols.farmer_protocol import FarmingInfo
from flange.protocols.harvester_protocol import Plot
...
from flange.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSFlangeConnection
    ):
        """
