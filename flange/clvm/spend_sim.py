...
from flange.consensus.coinbase import create_pool_coin, create_farmer_coin
from flange.consensus.block_rewards import calculate_pool_reward, calculate_base_farmer_reward
from flange.consensus.cost_calculator import NPCResult

"""
The purpose of this file is to provide a lightweight simulator for the testing of Flangelisp smart contracts.
...
There is also a provided NodeClient object which implements many of the methods from flange.rpc.full_node_rpc_client
