...
from flange.consensus.network_type import NetworkType
...
from flange.protocols.harvester_protocol import PoolDifficulty
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSFlangeConnection
    ):
        """
