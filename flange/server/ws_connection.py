...
from flange.cmds.init_funcs import flange_full_version_str
from flange.protocols.protocol_message_types import ProtocolMessageTypes
from flange.protocols.shared_protocol import Capability, Handshake
...
from flange.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSFlangeConnection:
    """
