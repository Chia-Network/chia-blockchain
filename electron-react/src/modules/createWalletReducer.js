...
export const ALL_OPTIONS = "ALL_OPTIONS"
  ...
  export const changeCreateWallet = (item) => ({ type: 'CREATE_OPTIONS', item: item});
  export const createState = (created, pending) => ({type: 'CREATE_STATE', created: created, pending: pending});
