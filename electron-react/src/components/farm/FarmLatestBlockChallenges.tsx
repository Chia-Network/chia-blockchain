...
import { Card, CardContent, Typography, Link, Tooltip } from '@material-ui/core';
...
const cols = [{
  ...
  title: <Trans id="FarmLatestBlockChallenges.challengeHash">Challenge Hash</Trans>,
}, {
  width: '150px',
  field: 'height',
  ...
  title: (
    <Flex alignItems="center" gap={1}>
      <span>
        <Trans id="FarmLatestBlockChallenges.bestEstimate">Best Estimate</Trans>
      </span>
      <TooltipIcon>
        <Trans id="FarmLatestBlockChallenges.bestEstimateTooltip">
          Best Estimate is how many seconds of time must be proved for your proofs.
        </Trans>
      </TooltipIcon>
    </Flex>
  ...
  return (
    <BlockContainer>
      <Flex flexDirection="column" gap={3}>
          ...
          {hasPlots && (
            <TooltipIcon>
              <Trans id="FarmLatestBlockChallenges.description">
                Below are the current block challenges.
                You may or may not have a proof of space for these challenges.
        ...
        <Table
          cols={cols}
          rows={latestChallenges}
        />
        <Typography variant="caption">
          <Trans id="FarmLatestBlockChallenges.subDescription">
            *Want to explore Chia’s blocks further?
            Check out <Link color="primary" href="https://www.chiaexplorer.com/" target="_blank">Chia Explorer</Link> built by an open source developer.
          </Trans>
        </Typography>
      </Flex>
    </BlockContainer>
