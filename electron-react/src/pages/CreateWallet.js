...
import { makeStyles, Grid, Typography, Paper, List, Button, Box } from '@material-ui/core';
...
import { changeCreateWallet, ALL_OPTIONS, CREATE_CC_WALLET_OPTIONS, CRAETE_EXISTING_CC, CREATE_NEW_CC } from '../modules/createWalletReducer';
...
const CreateViewSwitch = () => {
    ...
    if (view === ALL_OPTIONS) {
        ...
        return (
            <CCListItems></CCListItems>
        )
    } else if (view == CREATE_NEW_CC) {
        return (
        <CreateNewCCWallet></CreateNewCCWallet>
        )

    } else if (view == CRAETE_EXISTING_CC) {
        return (
            <CreateExistingCCWallet></CreateExistingCCWallet>
        )
    }
}
