...
function BalanceCard(props: BalanceCardProps) {
  ...
  const balance_ptotal_hddcoin = mojo_to_colouredcoin_string(balance_ptotal);
  const balance_pending_hddcoin = mojo_to_colouredcoin_string(balance_pending);
  const balance_change_hddcoin = mojo_to_colouredcoin_string(balance_change);
  const acc_content =
    balancebox_1 +
    balancebox_2 +
    balancebox_ptotal +
