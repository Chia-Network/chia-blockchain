...
For focused work, read the matching context doc under `.cursor/context/` before broad source exploration. For review or
audit work, also check `.cursor/context/`.

Cursor behavior is guided by `.cursor/rules/`, including context routing,
test harness selection, and repository tooling guardrails.
