...
If you want to learn more about this project, read the [docs](https://docs.chia.net), or check out the [green paper](https://www.chia.net/assets/ChiaGreenPaper.pdf).
