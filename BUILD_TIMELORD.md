...
required to run a [Timelord](https://github.com/ChandlerFerry/deafwave-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/ChandlerFerry/deafwave-blockchain/blob/main/install-timelord.sh)
