...
required to run a [Timelord](https://github.com/Flange-Network/chia-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Flange-Network/chia-blockchain/blob/main/install-timelord.sh)
