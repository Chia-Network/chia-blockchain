...
required to run a [Timelord](https://github.com/HDDcoin-Network/hddcoin-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/HDDcoin-Network/hddcoin-blockchain/blob/main/install-timelord.sh)
