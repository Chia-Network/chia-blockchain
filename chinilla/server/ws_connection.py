...
from chinilla.protocols.shared_protocol import Capability, Handshake
...
from chinilla.util.errors import Err, ProtocolError
from chinilla.util.ints import uint8, uint16

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from chinilla.util.network import class_for_type, is_localhost
