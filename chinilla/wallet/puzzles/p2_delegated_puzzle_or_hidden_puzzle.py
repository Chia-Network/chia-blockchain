...
p2_delegated_puzzle_or_hidden_puzzle is essentially the "standard coin" in chinilla.
...
- The user's wallet contains a primary sk/pk pair which are used to derive to one
  ...
  https://chinillalisp.com/docs/standard_transaction .  Therefore when a wallet needs
...
- Python code previously appeared which was written like:
  ...
  In context, delegated_puzzle_solution here is any *chinillalisp program*, here one
  ...
  The second and third arguments are a chinillalisp program and its corresponding
