from chinilla.protocols.protocol_message_types import ProtocolMessageTypes as pmt, ProtocolMessageTypes
...
VALID_REPLY_MESSAGE_MAP = {
    ...
    # pmt.handshake is handled in WSChinillaConnection.perform_handshake
