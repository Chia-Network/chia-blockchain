...
from chinilla.seeder.peer_record import PeerRecord, PeerReliability
...
class Crawler:
    ...
    async def connect_task(self, peer):
        async def peer_action(peer: ws.WSChinillaConnection):
    ...
    async def new_peak(self, request: full_node_protocol.NewPeak, peer: ws.WSChinillaConnection):
        try:
            peer_info = peer.get_peer_info()
    ...
    async def on_connect(self, connection: ws.WSChinillaConnection):
        pass
