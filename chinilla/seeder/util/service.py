...
from chinilla.daemon.server import pid_path_for_service
...
def launch_service(root_path: Path, service_command) -> Tuple[subprocess.Popen, Path]:
    ...
    print(f"Launching service with CHINILLA_ROOT: {os.environ['CHINILLA_ROOT']}")
...
if getattr(sys, "frozen", False):
    name_map = {
        "chinilla_seeder": "chinilla_seeder",
        "chinilla_seeder_crawler": "chinilla_seeder_crawler",
        "chinilla_seeder_server": "chinilla_seeder_server",
    }
