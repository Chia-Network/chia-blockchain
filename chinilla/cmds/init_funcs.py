...
from chinilla.ssl.create_ssl import (
    ensure_ssl_dirs,
    generate_ca_signed_cert,
    get_chinilla_ca_crt_key,
    make_ca_cert,
...
from chinilla.util.ssl_check import (
...
from chinilla.wallet.derive_keys import master_sk_to_pool_sk, master_sk_to_wallet_sk
from chinilla.cmds.configure import configure
...
def create_all_ssl(root_path: Path):
    ...
    write_ssl_cert_and_key(chinilla_ca_crt_path, chinilla_ca_crt, chinilla_ca_key_path, chinilla_ca_key)
    ...
    chinilla_ca_crt, chinilla_ca_key = get_chinilla_ca_crt_key()
    generate_ssl_for_nodes(ssl_dir, chinilla_ca_crt, chinilla_ca_key, False, overwrite=False)
