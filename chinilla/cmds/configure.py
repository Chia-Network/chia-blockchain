...
from chinilla.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet:
        if testnet == "true" or testnet == "t":
            ...
            mainnet_port = "8444"
            mainnet_introducer = "introducer.chinilla.net"
            mainnet_dns_introducer = "dns-introducer.chinilla.net"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running chinilla services for changes to take effect")
