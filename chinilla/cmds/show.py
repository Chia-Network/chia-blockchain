    ...
    try:
        ...
        if state:
            ...
            if synced:
                ...
                print("You may be able to expedite with 'chinilla show -a host:port' using a known node.\n")
        ...
        if add_connection:
            if ":" not in add_connection:
                print("Enter a valid IP and port in the following format: 10.5.4.3:42000")
            else:
                ip, port = (
