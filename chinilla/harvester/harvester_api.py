...
from chinilla.plotting.util import PlotInfo, parse_plot_info
from chinilla.protocols import harvester_protocol
from chinilla.protocols.farmer_protocol import FarmingInfo
...
from chinilla.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSChinillaConnection
    ):
        """
