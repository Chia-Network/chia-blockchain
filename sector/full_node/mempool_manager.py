...
from sector.full_node.mempool_check_conditions import mempool_check_conditions_dict, get_name_puzzle_conditions
...
from sector.types.mempool_item import MempoolItem
from sector.types.spend_bundle import SpendBundle
from sector.util.clvm import int_from_bytes
...
from sector.util.generator_tools import additions_for_npc
...
class MempoolManager:
    def __init__(self, coin_store: CoinStore, consensus_constants: ConsensusConstants):
        ...
        # transactions. This prevents spam. This is equivalent to 0.055 XSC per block, or about 0.00005 XSC for two
        # spends.
