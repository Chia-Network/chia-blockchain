...
from sector.protocols.wallet_protocol import RespondAdditions, RejectAdditionsRequest
...
from sector.util.ints import uint64, uint32, uint8

from sector.wallet.did_wallet.did_info import DIDInfo
