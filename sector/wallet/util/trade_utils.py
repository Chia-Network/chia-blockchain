...
from sector.util.condition_tools import conditions_dict_for_solution
from sector.wallet.cc_wallet import cc_utils
    ...
    try:
        ...
        for coinsol in trade_offer.coin_solutions:
            ...
            if r:
                ...
                if "sector" in cc_discrepancies:
                    cc_discrepancies["sector"] = cc_discrepancies["sector"] + diff
                else:
                    cc_discrepancies["sector"] = diff
