...
from sector.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "55695"
            testnet_introducer = "beta1_introducer.sectornetwork.world"
            testnet = "testnet0"
            ...
            mainnet_port = "5695"
            mainnet_introducer = "introducer.sectornetwork.world"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running sector services for changes to take effect")
