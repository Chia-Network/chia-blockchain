...
from sector.cmds.init_funcs import sector_full_version_str
from sector.protocols.protocol_message_types import ProtocolMessageTypes
from sector.protocols.shared_protocol import Capability, Handshake
from sector.server.outbound_message import Message, NodeType, make_msg
from sector.server.rate_limits import RateLimiter
...
from sector.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSSectorConnection:
    """
