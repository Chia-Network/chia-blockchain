...
from sector.daemon.server import singleton, service_launch_lock_path
from sector.server.ssl_context import chia_ssl_ca_paths, private_ssl_ca_paths
...
class Service:
    def __init__(
        ...
        proctitle_name = f"sector_{service_name}"
    ...
    async def wait_closed(self) -> None:
        ...
        self._log.info("Waiting for SectorServer to be closed")
