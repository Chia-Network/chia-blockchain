...
from sector.consensus.pot_iterations import calculate_sp_iters, is_overflow_block
...
from sector.timelord.timelord_state import LastState
from sector.timelord.types import Chain, IterationType, StateType
...
class Timelord:
    def __init__(self, root_path, config: Dict, constants: ConsensusConstants):
        ...
        self.server: Optional[SectorServer] = None
