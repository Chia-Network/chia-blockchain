...
testnet_kwargs = {
    ...
    "NUMBER_ZERO_BITS_PLOT_FILTER": 6,  # H(plot signature of the challenge) must start with these many zeroes
    ...
    # Default used for tests is std_hash(b'')34a5de60dee5c3899c7d3b9c4eb1b4d3e143948439c3b1bb6d6de35c6ba8bfb9
