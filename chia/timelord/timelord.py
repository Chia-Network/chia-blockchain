...
from deafwave.consensus.pot_iterations import calculate_sp_iters, is_overflow_block
...
from deafwave.timelord.iters_from_block import iters_from_block
from deafwave.timelord.timelord_state import LastState
from deafwave.timelord.types import Chain, IterationType, StateType
from deafwave.types.blockchain_format.classgroup import ClassgroupElement
from deafwave.types.blockchain_format.reward_chain_block import RewardChainBlock
from deafwave.types.blockchain_format.sized_bytes import bytes32
from deafwave.types.blockchain_format.slots import (
...
class Timelord:
    def __init__(self, root_path, config: Dict, constants: ConsensusConstants):
        ...
        self.server: Optional[DeafwaveServer] = None
