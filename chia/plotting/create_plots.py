...
from chia.plotting.plot_tools import PlotManager, stream_plot_info_ph, stream_plot_info_pk
    ...
    for i in range(num):
        ...
        if args.exclude_final_dir:
            ...
            if resolved_final_dir not in plot_directories_list:
                ...
                config = PlotManager(root_path).add_plot_directory(resolved_final_dir)
