...
class Delta:
    ...
    def empty(self) -> bool:
        return self.valid.empty() and self.invalid.empty() and self.keys_missing.empty()

    def __str__(self) -> str:
        return f"valid {self.valid}, invalid {self.invalid}, keys missing: {self.keys_missing}"
