...
rate_limits_other = {
    ...
    ProtocolMessageTypes.request_header_block_blobs: RLSettings(500, 100),
    ProtocolMessageTypes.reject_header_block_blobs: RLSettings(100, 100),
    ProtocolMessageTypes.respond_header_block_blobs: RLSettings(500, 2 * 1024 * 1024, 100 * 1024 * 1024),
