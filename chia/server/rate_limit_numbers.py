...
rate_limits = {
    1: {
        ...
        "rate_limits_other": {
            ...
            ProtocolMessageTypes.request_remove_coin_subscriptions: RLSettings(2000, 1 * 1024 * 1024),
            ProtocolMessageTypes.respond_remove_coin_subscriptions: RLSettings(2000, 1 * 1024 * 1024),
