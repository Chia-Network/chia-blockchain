...
rate_limits = {
    1: {
        ...
        "rate_limits_other": {
            ...
            ProtocolMessageTypes.farming_info_v2: RLSettings(100, 1024),
            ...
            ProtocolMessageTypes.respond_plots_v2: RLSettings(10, 100 * 1024 * 1024),
            ProtocolMessageTypes.plot_sync_start: RLSettings(1000, 100 * 1024 * 1024),
            ProtocolMessageTypes.plot_sync_start_v2: RLSettings(1000, 100 * 1024 * 1024),
            ProtocolMessageTypes.plot_sync_loaded: RLSettings(1000, 100 * 1024 * 1024),
            ProtocolMessageTypes.plot_sync_loaded_v2: RLSettings(1000, 100 * 1024 * 1024),
