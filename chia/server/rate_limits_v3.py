...
from chia.protocols.shared_protocol import ConfigureRateLimits
...
class RLSettingsV3:
    # Number of in-flight requests per message type, None is unlimited
...
rate_limits_v3: dict[ProtocolMessageTypes, RLSettingsV3] = {
    ProtocolMessageTypes.request_blocks: RLSettingsV3(window_size=1),
    ...
    ProtocolMessageTypes.request_block_header: RLSettingsV3(window_size=1),
    ...
    ProtocolMessageTypes.request_block_headers: RLSettingsV3(window_size=1),
    ...
    ProtocolMessageTypes.request_header_blocks: RLSettingsV3(window_size=1),
    ...
    ProtocolMessageTypes.register_for_ph_updates: RLSettingsV3(window_size=1),
    ProtocolMessageTypes.respond_to_ph_updates: RLSettingsV3(window_size=None),
    ProtocolMessageTypes.register_for_coin_updates: RLSettingsV3(window_size=1),
    ...
    ProtocolMessageTypes.request_coin_state: RLSettingsV3(window_size=1),
    ...
    ProtocolMessageTypes.request_additions: RLSettingsV3(window_size=1),
    ...
    ProtocolMessageTypes.request_removals: RLSettingsV3(window_size=1),
...
def rl_v3_to_configure_message(
    ...
    """
    Encode a set of rate limits into a `ConfigureRateLimits` message. If
    ...
    return ConfigureRateLimits(settings=message_settings)


def rl_settings_v3_from_configure_message(
    msg: ConfigureRateLimits,
) -> dict[ProtocolMessageTypes, RLSettingsV3]:
    """
    Parse a `ConfigureRateLimits` message rate limit settings. The peer
