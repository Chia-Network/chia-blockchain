...
from chia.custody.custody_api import CustodyAPI
from chia.rpc.custody_rpc_api import CustodyRpcApi
...
async def async_main() -> int:
    ...
    create_all_ssl(
        root_path=DEFAULT_ROOT_PATH,
        private_node_names=["custody"],
        public_node_names=["custody"],
        overwrite=False,
    )

    service = create_custody_service(DEFAULT_ROOT_PATH, config)
