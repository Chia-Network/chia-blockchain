...
class DIDWallet:
    ...
    async def create_new_did_wallet(
        ...
        try:
            await self.generate_new_decentralised_id(amount, action_scope, extra_conditions)
        except Exception:
    ...
    async def create_attestment(
        ...
        p2_solution = self.standard_wallet.make_solution(
            ...
            conditions=(CreateCoinAnnouncement(coin_id=coin_name, msg=coin_name), *extra_conditions),
        )
