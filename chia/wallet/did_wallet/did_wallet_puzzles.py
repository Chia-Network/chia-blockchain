...
DID_INNERPUZ_MOD = load_clvm("did_innerpuz.clsp", package_or_requirement="chia.wallet.did_wallet.puzzles")
SINGLETON_TOP_LAYER_MOD = load_clvm("singleton_top_layer.clsp", package_or_requirement="chia.clvm.singletons.puzzles")
