...
class WalletActionStore:
    ...
    async def create(cls, db_wrapper: DBWrapper):
        ...
        await self.db_connection.execute("CREATE INDEX IF NOT EXISTS aq_name on action_queue(name)")

        await self.db_connection.execute("CREATE INDEX IF NOT EXISTS aq_wallet_id on action_queue(wallet_id)")

        await self.db_connection.execute("CREATE INDEX IF NOT EXISTS aq_wallet_type on action_queue(wallet_type)")
