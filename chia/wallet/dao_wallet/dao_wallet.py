...
class DAOWallet:
    ...
    async def generate_new_dao(
        ...
        full_spend = WalletSpendBundle.aggregate([tx_record.spend_bundle, launcher_sb, eve_spend])
    ...
    async def generate_new_proposal(
        ...
        full_spend = WalletSpendBundle.aggregate([tx_record.spend_bundle, eve_spend, launcher_sb])
    ...
    async def create_proposal_close_spend(
        ...
        if fee > 0:
            ...
            assert chia_tx.spend_bundle is not None
            full_spend = WalletSpendBundle.aggregate([spend_bundle, chia_tx.spend_bundle])
        else:
            full_spend = WalletSpendBundle.aggregate([spend_bundle])
