...
class WalletStateManager:
    ...
    async def coin_added(
        ...
        is_clawback = parent_coin_record is not None and parent_coin_record.coin_type == CoinType.CLAWBACK

        if coinbase or not coin_confirmed_transaction and not change and is_clawback:
            tx_record = TransactionRecord(
