...
def launch_conditions_and_coinsol(
    ...
    launcher_coin_solution = CoinSolution(launcher_coin, SINGLETON_LAUNCHER, launcher_solution,)
...
def puzzle_for_singleton(launcher_id: bytes32, inner_puz: Program) -> Program:
    return SINGLETON_MOD.curry((SINGLETON_MOD_HASH, (launcher_id, SINGLETON_LAUNCHER_HASH)), inner_puz,)
...
def claim_p2_singleton(
    p2_singleton_coin: Coin, singleton_inner_puzhash: bytes32, launcher_id: bytes32,
