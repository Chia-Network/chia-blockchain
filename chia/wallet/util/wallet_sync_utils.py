...
async def subscribe_to_phs(
    ...
    all_coins_state: Optional[RespondToPhUpdates] = await peer.register_interest_in_puzzle_hash(msg, timeout=120)
...
async def subscribe_to_coin_updates(
    ...
    all_coins_state: Optional[RespondToCoinUpdates] = await peer.register_interest_in_coin(msg, timeout=120)
