...
from chia.pools.plotnft_drivers import GetNextPlotNFTError, PlotNFT, PoolConfig, PoolReward, UserConfig
        ...
        try:
            ...
            user_key_is_owned = (
                await wallet_state_manager.puzzle_store.index_for_puzzle_hash(
                    puzzle_hash_for_synthetic_public_key(next_plot_nft.inner_puzzle.user_config.synthetic_pubkey)
                )
                is not None
            )
