...
#     )
#     tr = await special_wallet.standard_wallet.generate_signed_transaction(amount=amount, puzzle_hash=full_puzzle)
...
#     input_list: List,
# ) -> SpendBundle:
#     coins = await special_wallet.select_coins(uint64(1))
#     coin = coins.pop()
