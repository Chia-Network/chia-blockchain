...
async def migrate_coin_of_interest(log: logging.Logger, db: WrapperConnection) -> None:
...
async def migrate_is_my_offer(log: logging.Logger, db_connection: WrapperConnection) -> None:  # pragma: no cover
    """
