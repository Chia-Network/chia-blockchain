...
from chia_rs import BLSCache, ConsensusConstants, SpendBundle
...
from chia.protocols.wallet_protocol import RemovedMempoolItem
...
class MempoolProtocolMixin(ABC):
    ...
    log: logging.Logger
    root_path: Path
    simulator_transaction_callback: Callable[[bytes32], Awaitable[None]] | None
