...
def get_hints_and_subscription_coin_ids(
    ...
    has_coin_id_subscription: Callable[[bytes32], bool],
    has_puzzle_hash_subscription: Callable[[bytes32], bool],
