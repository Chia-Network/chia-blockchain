...
from chia.full_node.full_node_block_processing import BlockProcessingMixin, PeakPostProcessingResult
from chia.full_node.full_node_compact_vdf import CompactVdfMixin
...
class SyncMixin(BlockProcessingMixin, CompactVdfMixin):
    ...
    _sync_task_list: list[asyncio.Task[None]]
    _ui_tasks: set[Any]
