...
from chia.util.api_decorators import api_request, peer_required, bytes_required, execute_task, msg_reply_type
...
class FullNodeAPI:
    ...
    @peer_required
    @api_request
    @msg_reply_type([ProtocolMessageTypes.respond_peers])
    ...
    @api_request
    @msg_reply_type([ProtocolMessageTypes.respond_transaction])
    ...
    @api_request
    @msg_reply_type([ProtocolMessageTypes.respond_proof_of_weight])
    ...
    @api_request
    @msg_reply_type([ProtocolMessageTypes.respond_block, ProtocolMessageTypes.reject_block])
    ...
    @api_request
    @msg_reply_type([ProtocolMessageTypes.respond_blocks, ProtocolMessageTypes.reject_blocks])
    ...
    @api_request
    @msg_reply_type([ProtocolMessageTypes.respond_unfinished_block])
    ...
    @api_request
    @msg_reply_type([ProtocolMessageTypes.respond_signage_point, ProtocolMessageTypes.respond_end_of_sub_slot])
    ...
    @peer_required
    @api_request
    @msg_reply_type([ProtocolMessageTypes.respond_compact_vdf])
