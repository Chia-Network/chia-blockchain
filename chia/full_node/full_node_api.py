...
from chia.util.api_decorators import api_request, peer_required, bytes_required, execute_task, returns_none
...
class FullNodeAPI:
    ...
    @api_request
    @returns_none(ProtocolMessageTypes.respond_proof_of_weight)
