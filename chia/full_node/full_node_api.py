...
from chia.util.api_decorators import api_request, peer_required, bytes_required, execute_task, replay_type
...
class FullNodeAPI:
    ...
    @api_request
    @replay_type(ProtocolMessageTypes.respond_proof_of_weight)
