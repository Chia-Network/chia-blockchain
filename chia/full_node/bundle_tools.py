...
from chia_rs import SpendBundle, solution_generator, solution_generator_2026, solution_generator_backrefs
...
def simple_solution_generator_2026(bundle: SpendBundle) -> BlockGenerator:
    ...
    return BlockGenerator(SerializedProgram.from_program_bytes(block_program), [])
