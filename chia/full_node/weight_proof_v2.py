...
from chia.util.streamable import recurse_jsonify, dataclass_from_dict
...
async def validate_weight_proof_no_fork_point(
    ...
    summaries, sub_epoch_weight_list = _validate_sub_epoch_summaries(constants, weight_proof)
