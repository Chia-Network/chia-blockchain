...
@click.option( "-n", "--number-addresses", help="Set the number of new public wallet receive addresses.", type=int, default=1, show_default=True)
@click.option("-i", "--id", help="Id of the wallet to use", type=int, default=1, show_default=True, required=True)
@click.option("-f", "--fingerprint", help="Set the fingerprint to specify which wallet to use", type=int)
def get_address_cmd(wallet_rpc_port: int, id, number_addresses, fingerprint: int) -> None:
