...
def get_csv_cmd(wallet_rpc_port: int, fingerprint: int, id: int, offset: int, file: str, date_fmt: str) -> None:
    extra_params = {"id": id, "offset": offset, "file": file, "date_fmt": date_fmt}
    import asyncio
