...
def test_pool_lifecycle(cost_logger: CostLogger):
    # START TESTS
    ...
    fork_coin_db.update_coin_store_for_spend_bundle(
        cost_logger.add_cost("Self Pooling -> Pooling", SpendBundle([post_launch_coinsol], G2Element())),
        time,
    ...
    coin_db.update_coin_store_for_spend_bundle(
        cost_logger.add_cost("Forward Pool Reward (pooling)", SpendBundle(coin_sols, G2Element())),
        time,
        DEFAULT_CONSTANTS.MAX_BLOCK_COST_CLVM,
    )
    ...
    # Spend it!
    coin_db.update_coin_store_for_spend_bundle(
        cost_logger.add_cost("Pooling -> Waiting Room", SpendBundle([travel_coinsol], sig)),
        time,
        DEFAULT_CONSTANTS.MAX_BLOCK_COST_CLVM,
    )
    ...
    # Spend it!
    coin_db.update_coin_store_for_spend_bundle(
        cost_logger.add_cost("Forward Pool Reward (waiting_room)", SpendBundle(coin_sols, G2Element())),
        time,
        DEFAULT_CONSTANTS.MAX_BLOCK_COST_CLVM,
    )
    ...
    # Spend it!
    coin_db.update_coin_store_for_spend_bundle(
        cost_logger.add_cost("Waiting Room -> Self Custody", SpendBundle([return_coinsol], sig)),
        time,
        DEFAULT_CONSTANTS.MAX_BLOCK_COST_CLVM,
    )
    ...
    # Spend it!
    coin_db.update_coin_store_for_spend_bundle(
        cost_logger.add_cost("Claim Pool Reward", SpendBundle(coin_sols, G2Element())),
        time,
        DEFAULT_CONSTANTS.MAX_BLOCK_COST_CLVM,
    )
