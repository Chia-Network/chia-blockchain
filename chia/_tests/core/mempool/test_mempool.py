...
async def test_skip_error_items(old: bool) -> None:
    ...
    result = await create_block(local_get_unspent_lineage_info, DEFAULT_CONSTANTS, uint32(10))
...
async def test_create_block_generator(old: bool) -> None:
    ...
    block = await create_block(get_unspent_lineage_info_for_puzzle_hash, test_constants, uint32(0))
