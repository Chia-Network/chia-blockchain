...
async def test_farmer_get_harvesters_and_summary(
    ...
    async def non_zero_plots() -> bool:
        ...
        return len(harvester_plots) == 170
...
@pytest.mark.parametrize(
    ...
    [
        (FarmerRpcClient.get_harvester_plots_valid, [], "filename", False, 170),
        (FarmerRpcClient.get_harvester_plots_valid, [], "size", True, 170),
        (
