...
async def test_peer_queue_prioritization_fallback() -> None:
    ...
    assert math.isclose(queue._normal_priority_queues[peer3].priority_queue.queue[0][0], -1.0)
    ...
    assert math.isinf(queue._normal_priority_queues[peer3].priority_queue.queue[0][0])
    entry = await queue.pop()
...
async def test_normal_queue_deficit_round_robin() -> None:
    ...
    assert queue._normal_priority_queues[peer1].deficit == 5
    assert queue._normal_priority_queues[peer2].deficit == 0
    assert queue._normal_priority_queues[peer3].deficit == 5
    assert queue._normal_priority_queues[peer4].deficit == 5
    ...
    assert queue._normal_priority_queues[peer1].deficit == 15
    assert queue._normal_priority_queues[peer2].deficit == 0
    assert queue._normal_priority_queues[peer3].deficit == 0
    assert queue._normal_priority_queues[peer4].deficit == 15
    ...
    for peer in [peer1, peer2, peer3]:
        ...
        assert peer not in queue._normal_priority_queues
    ...
    assert queue._normal_priority_queues[peer4].deficit == 0
    assert queue._list_cursor == 0
