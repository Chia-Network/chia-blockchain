...
from chia.wallet.wallet_node import WalletServiceManagementMessage
...
async def test_dao_resync(
    self_hostname: str, two_not_started_wallet_nodes: OldSimulatorsAndWallets, trusted: bool
) -> None:
    ...
    async with contextlib.AsyncExitStack() as exit_stack:
        await exit_stack.enter_async_context(wallet_node_0.manage())
    ...
    async with contextlib.AsyncExitStack() as exit_stack:
        await exit_stack.enter_async_context(
            wallet_node_0.manage(
                WalletServiceManagementMessage(ServiceManagementAction.restart, fingerprint=fingerprint_0)
            )
        )
        await exit_stack.enter_async_context(
