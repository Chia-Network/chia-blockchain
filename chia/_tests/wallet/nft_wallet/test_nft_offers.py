...
async def test_nft_offer_with_fee(wallet_environments: WalletTestFramework) -> None:
    ...
    nft_info: PuzzleInfo | None = match_puzzle(UnknownPuzzle(known_puzzle=nft_to_offer.full_puzzle))
    ...
    [_maker_offer], signing_response = await env_0.wallet_state_manager.signer.sign_offers(
    ...
    nft_to_buy_info: PuzzleInfo | None = match_puzzle(UnknownPuzzle(known_puzzle=nft_to_buy.full_puzzle))
...
async def test_nft_offer_with_metadata_update(wallet_environments: WalletTestFramework) -> None:
    ...
    updated_nft_info = match_puzzle(UnknownPuzzle(known_puzzle=updated_nft.full_puzzle))
...
async def test_nft_offer_nft_for_nft(wallet_environments: WalletTestFramework) -> None:
    ...
    nft_to_offer = coins_maker[0]
    nft_to_offer_info: PuzzleInfo | None = match_puzzle(UnknownPuzzle(known_puzzle=nft_to_offer.full_puzzle))
    ...
    nft_to_take_info: PuzzleInfo | None = match_puzzle(UnknownPuzzle(known_puzzle=nft_to_take.full_puzzle))
...
async def test_nft_offer_nft0_and_xch_for_cat(
    ...
    [maker_offer], signing_response = await env_0.wallet_state_manager.signer.sign_offers(
        [Offer.from_bytes(trade_make.offer)]
    )
