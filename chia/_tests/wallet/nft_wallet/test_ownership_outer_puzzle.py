...
def test_ownership_outer_puzzle() -> None:
    ...
    ownership_driver: PuzzleInfo | None = match_puzzle(UnknownPuzzle(known_program=ownership_puzzle))
    ownership_driver_empty: PuzzleInfo | None = match_puzzle(UnknownPuzzle(known_program=ownership_puzzle_empty))
    ownership_driver_default: PuzzleInfo | None = match_puzzle(UnknownPuzzle(known_program=ownership_puzzle_default))
    transfer_program_driver: PuzzleInfo | None = match_puzzle(UnknownPuzzle(known_program=transfer_program_default))
    ...
    assert get_inner_puzzle(ownership_driver, UnknownPuzzle(known_program=ownership_puzzle)) == ACS
