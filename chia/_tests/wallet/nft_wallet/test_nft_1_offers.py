...
async def test_nft_offer_request_nft(wallet_environments: WalletTestFramework, zero_royalties: bool) -> None:
    ...
    nft_to_request_info: PuzzleInfo | None = match_puzzle(UnknownPuzzle(known_puzzle=nft_to_request.full_puzzle))
...
async def test_nft_offer_request_nft_for_cat(
    ...
    nft_to_request = coins_taker[0]
    nft_to_request_info = match_puzzle(UnknownPuzzle(known_puzzle=nft_to_request.full_puzzle))
...
async def test_nft_offer_sell_cancel(wallet_environments: WalletTestFramework) -> None:
    ...
    nft_to_offer = coins_maker[0]
    nft_to_offer_info = match_puzzle(UnknownPuzzle(known_puzzle=nft_to_offer.full_puzzle))
...
async def test_complex_nft_offer(
    ...
    nft_taker_1_info = match_puzzle(UnknownPuzzle(known_puzzle=taker_nfts[0].full_puzzle))
    nft_taker_2_info = match_puzzle(UnknownPuzzle(known_puzzle=taker_nfts[1].full_puzzle))
    ...
    maker_nft_info = match_puzzle(UnknownPuzzle(known_puzzle=taker_nfts[0].full_puzzle))
