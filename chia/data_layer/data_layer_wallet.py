...
class DataLayerWallet:
    ...
    async def new_launcher_spend(
        ...
        await self.wallet_state_manager.interested_store.add_interested_puzzle_hash(launcher_id, self.id(), in_transaction)
    ...
    async def generate_new_reporter(
        ...
        await self.wallet_state_manager.interested_store.add_interested_puzzle_hash(singleton_record.launcher_id, self.id(), False)
    ...
    async def singleton_removed(self, parent_spend: CoinSpend, height: uint32) -> None:
        ...
        if matched:
            ...
            await self.wallet_state_manager.interested_store.add_interested_coin_id(new_singleton.name())
