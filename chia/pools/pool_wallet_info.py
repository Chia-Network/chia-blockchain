...
from chia.util.ints import UInt8Enum, uint8, uint32
from chia.util.streamable import Streamable, streamable


class PoolSingletonState(UInt8Enum):
    """
...
def create_pool_state(
    ...
    ps = PoolState(POOL_PROTOCOL_VERSION, state, target_puzzle_hash, owner_pubkey, pool_url, relative_lock_height)
