...
class Err(Enum):
    ...
    ASSERT_BEFORE_HEIGHT_RELATIVE_FAILED = 128
    ASSERT_BEFORE_HEIGHT_ABSOLUTE_FAILED = 129
    ASSERT_BEFORE_SECONDS_ABSOLUTE_FAILED = 130
    ASSERT_BEFORE_SECONDS_RELATIVE_FAILED = 131
