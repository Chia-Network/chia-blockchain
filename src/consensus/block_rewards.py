...
_sub_blocks_per_year = 1681920  # 32 * 6 * 24 * 365
...
def calculate_pool_reward(height: uint32) -> uint64:
    ...
    elif height < 3 * _sub_blocks_per_year:
        return uint64(int((7 / 8) * 2 * _mojo_per_chia))
    elif height < 6 * _sub_blocks_per_year:
        return uint64(int((7 / 8) * 1 * _mojo_per_chia))
    elif height < 9 * _sub_blocks_per_year:
        return uint64(int((7 / 8) * 0.5 * _mojo_per_chia))
    elif height < 12 * _sub_blocks_per_year:
