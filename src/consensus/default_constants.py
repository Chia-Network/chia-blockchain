...
testnet_kwargs = {
    ...
    "FIRST_CC_CHALLENGE": bytes32(bytes([0x00] * 32)),
    "FIRST_RC_CHALLENGE": bytes32(bytes([0x00] * 32)),
    "GENESIS_PRE_FARM_POOL_PUZZLE_HASH": bytes.fromhex(
        "23b039a829f3ed14a260355b9fc55d9ccc4539f05bd4bf529fd2630de1751d52"
    ),
    "GENESIS_PREV_HASH": bytes32(bytes([0x00] * 32)),
    "GENESIS_SES_HASH": bytes32(bytes([0x00] * 32)),
