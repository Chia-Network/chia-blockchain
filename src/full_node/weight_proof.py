...
class WeightProofHandler:
    ...
    LAMBDA_L = 100
    C = 0.5
    MAX_SAMPLES = 100  # todo switch to 256 after testing / segment size resolved
    ...
    async def _handle_challenge_segment(
        ...
        first_sub_slots, first_rc_end_of_slot_vdf = await self.__first_sub_slots_data(header_block, header_blocks)
