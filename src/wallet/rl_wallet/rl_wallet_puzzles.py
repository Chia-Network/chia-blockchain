...
def rl_puzzle_for_pk(pubkey: bytes32, rate_amount: uint64, interval_time: uint64, origin_id: bytes32, clawback_pk: bytes32):
    """
...
def rl_make_solution_mode_2(my_puzzle_hash, consolidating_primary_input, consolidating_coin_puzzle_hash,
...
def solution_for_rl(my_parent_id, my_puzzlehash, my_amount, out_puzzlehash, out_amount, my_parent_parent_id,
                    parent_amount, interval, limit):
    """
