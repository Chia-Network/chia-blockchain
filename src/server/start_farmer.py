...
async def main():
    ...
    plotter_con_task, plotter_client, _ = await start_chia_client(plotter_peer, farmer, NodeType.PLOTTER)
    ...
    server, _, _ = await start_chia_server(host, port, farmer, NodeType.FULL_NODE)
