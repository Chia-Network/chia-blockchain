...
rate_limits_other = {
    ...
    ProtocolMessageTypes.request_compact_vdf: RLSettings(100, 1024),
    ProtocolMessageTypes.respond_compact_vdf: RLSettings(100, 100 * 1024),
    ...
    ProtocolMessageTypes.request_header_blocks: RLSettings(100, 100),
    ProtocolMessageTypes.reject_header_blocks: RLSettings(100, 100),
    ProtocolMessageTypes.respond_header_blocks: RLSettings(100, 100 * 1024),
