...
class BlockTools:
    ...
    def get_consecutive_blocks(
        ...
        while True:
            ...
            log.info(
                f"Sub slot finished. Sub-blocks included: {blocks_added_this_sub_slot} blocks_per_slot: "
        ...
        while True:
            ...
            for signage_point_index in range(0, constants.NUM_SPS_SUB_SLOT):
                ...
                for required_iters, proof_of_space in qualified_proofs:
                    ...
                    is_overflow_block = is_overflow_block(constants, uint8(signage_point_index))
