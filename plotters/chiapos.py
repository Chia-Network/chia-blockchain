"""
NOTE: This contains duplicate code from `shitcoin.cmds.plots`.
After `shitcoin plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
import pkg_resources
from shitcoin.plotting.create_plots import create_plots, resolve_plot_keys
...
def get_shitcoinpos_install_info() -> Optional[Dict[str, Any]]:
    shitcoinpos_version: str = pkg_resources.get_distribution("shitcoinpos").version
    return {"display_name": "shitcoin Proof of Space", "version": shitcoinpos_version, "installed": True}
...
def plot_shitcoin(args, root_path):
