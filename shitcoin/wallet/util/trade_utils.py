...
from shitcoin.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "shitcoin" in cc_discrepancies:
                    cc_discrepancies["shitcoin"] = cc_discrepancies["shitcoin"] + diff
                else:
                    cc_discrepancies["shitcoin"] = diff
