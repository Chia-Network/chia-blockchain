...
from shitcoin.util.errors import ConsensusError, Err
...
def parse_sexp_to_condition(
    ...
    """
    Takes a shitcoinLisp sexp and returns a ConditionWithArgs.
...
def parse_sexp_to_conditions(
    ...
    """
    Takes a shitcoinLisp sexp (list) and returns the list of ConditionWithArgss
