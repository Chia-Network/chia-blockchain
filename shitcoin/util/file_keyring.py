...
from shitcoin.util.default_root import DEFAULT_KEYS_ROOT_PATH
...
class FileKeyring(FileSystemEventHandler):
    ...
    def get_symmetric_key(salt: bytes) -> bytes:
        from shitcoin.util.keychain import obtain_current_passphrase
    ...
    def write_keyring(self, fresh_salt: bool = False):
        from shitcoin.util.keyring_wrapper import KeyringWrapper
