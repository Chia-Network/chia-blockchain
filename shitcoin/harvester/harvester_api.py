...
from shitcoin.plotting.util import PlotInfo, parse_plot_info
from shitcoin.protocols import harvester_protocol
from shitcoin.protocols.farmer_protocol import FarmingInfo
from shitcoin.protocols.harvester_protocol import Plot
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSshitcoinConnection
    ):
        """
