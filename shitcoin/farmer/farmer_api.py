...
from shitcoin.consensus.network_type import NetworkType
from shitcoin.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from shitcoin.farmer.farmer import Farmer
from shitcoin.protocols import farmer_protocol, harvester_protocol
from shitcoin.protocols.harvester_protocol import PoolDifficulty
from shitcoin.protocols.pool_protocol import (
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSshitcoinConnection
    ):
        """
    ...
    @api_request
    @peer_required
    async def respond_plots(self, _: harvester_protocol.RespondPlots, peer: ws.WSshitcoinConnection):
