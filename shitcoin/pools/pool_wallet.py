...
from shitcoin.pools.pool_config import PoolWalletConfig, load_pool_config, update_pool_config
from shitcoin.pools.pool_wallet_info import (
    PoolWalletInfo,
    PoolSingletonState,
    PoolState,
    FARMING_TO_POOL,
...
from shitcoin.pools.pool_puzzles import (
...
class PoolWallet:
    ...
    async def create_new_pool_wallet_transaction(
        ...
        the same pooling puzzle. This puzzle is a `shitcoin singleton` that is
