import os
from shitcoin.plotters.bladebit import install_bladebit
from shitcoin.plotters.madmax import install_madmax


def install_plotter(plotter, root_path):
    if plotter == "shitcoinpos":
        print("shitcoinpos already installed. No action taken.")
        return
    elif plotter == "madmax":
        if not os.path.exists(root_path / "madmax-plotter/build/shitcoin_plot"):
