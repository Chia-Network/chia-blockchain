...
from shitcoin.cmds.wallet_funcs import print_balance, wallet_coin_unit
from shitcoin.pools.pool_wallet_info import PoolWalletInfo, PoolSingletonState
        ...
        try:
            ...
            while time.time() - start < 10:
                ...
                if len(tx.sent_to) > 0:
                    ...
                    print(f"Do shitcoin wallet get_transaction -f {fingerprint} -tx 0x{tx_record.name} to get status")
                    return None
        except Exception as e:
