...
from shitcoin.daemon.client import acquire_connection_to_daemon
from shitcoin.util.keychain import Keychain, obtain_current_passphrase, supports_os_passphrase_storage
from shitcoin.util.keyring_wrapper import DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE
from shitcoin.util.misc import prompt_yes_no
from shitcoin.util.ws_message import WsRpcMessage
    ...
    try:
        if supports_os_passphrase_storage():
            ...
            print(
                ...
                "Other shitcoin processes will be able to access your keys without prompting for your passphrase."
            )
...
def initialize_passphrase() -> None:
    if Keychain.has_master_passphrase():
        ...
        print("\nUse 'shitcoin passphrase set' or 'shitcoin passphrase remove' to update or remove your passphrase")
        sys.exit(1)
