...
from shitcoin.pools.pool_wallet_info import create_pool_state, FARMING_TO_POOL, PoolWalletInfo, PoolState
from shitcoin.protocols.protocol_message_types import ProtocolMessageTypes
from shitcoin.server.outbound_message import NodeType, make_msg
...
from shitcoin.util.keychain import KeyringIsLocked, bytes_to_mnemonic, generate_mnemonic
from shitcoin.util.path import path_from_root
...
from shitcoin.wallet.derive_keys import master_sk_to_singleton_owner_sk
...
from shitcoin.wallet.util.backup_utils import download_backup, get_backup_info, upload_backup
from shitcoin.wallet.util.trade_utils import trade_record_to_dict
...
from shitcoin.wallet.wallet_node import WalletNode
...
class WalletRpcApi:
    def __init__(self, wallet_node: WalletNode):
        ...
        self.service_name = "shitcoin_wallet"
    ...
    async def _state_changed(self, *args) -> List[WsRpcMessage]:
        ...
        return [create_payload_dict("state_changed", data, "shitcoin_wallet", "wallet_ui")]
    ...
    async def create_new_wallet(self, request: Dict):
        ...
        if request["wallet_type"] == "cc_wallet":
            ...
            if request["mode"] == "new":
                ...
                from shitcoin.pools.pool_wallet_info import initial_pool_state_from_dict
