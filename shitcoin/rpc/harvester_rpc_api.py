...
from shitcoin.harvester.harvester import Harvester
from shitcoin.util.ws_message import WsRpcMessage, create_payload_dict


class HarvesterRpcApi:
    def __init__(self, harvester: Harvester):
        self.service = harvester
        self.service_name = "shitcoin_harvester"
