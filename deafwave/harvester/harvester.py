...
import deafwave.server.ws_connection as ws  # lgtm [py/import-and-import-from]
from deafwave.consensus.constants import ConsensusConstants
from deafwave.plotting.plot_tools import PlotInfo
from deafwave.plotting.plot_tools import add_plot_directory as add_plot_directory_pt
from deafwave.plotting.plot_tools import get_plot_directories as get_plot_directories_pt
from deafwave.plotting.plot_tools import load_plots
from deafwave.plotting.plot_tools import remove_plot_directory as remove_plot_directory_pt
...
class Harvester:
    ...
    def on_disconnect(self, connection: ws.WSDeafwaveConnection):
