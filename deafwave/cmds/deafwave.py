...
from deafwave.cmds.configure import configure_cmd
from deafwave.cmds.farm import farm_cmd
from deafwave.cmds.init import init_cmd
from deafwave.cmds.keys import keys_cmd
from deafwave.cmds.netspace import netspace_cmd
from deafwave.cmds.plots import plots_cmd
from deafwave.cmds.show import show_cmd
from deafwave.cmds.start import start_cmd
from deafwave.cmds.stop import stop_cmd
from deafwave.cmds.wallet import wallet_cmd
...
@click.group(
    help=f"\n  Manage deafwave blockchain infrastructure ({__version__})\n",
    epilog="Try 'deafwave start node', 'deafwave netspace -d 192', or 'deafwave show -s'",
...
@cli.command("version", short_help="Show deafwave version")
def version_cmd() -> None:
    print(__version__)


@cli.command("run_daemon", short_help="Runs deafwave daemon")
@click.pass_context
