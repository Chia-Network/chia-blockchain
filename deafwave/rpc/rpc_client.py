...
from deafwave.server.ssl_context import private_ssl_ca_paths
...
class RpcClient:
    """
    Client to Deafwave RPC, connects to a local service. Uses HTTP/JSON, and converts back from
    ...
    async def create(cls, self_hostname: str, port: uint16, root_path, net_config):
        ...
        self.ssl_context = ssl_context_for_client(
