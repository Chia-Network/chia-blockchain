...
## 1.1.6 Chives Blockchain 2021-05-20
...
## 1.1.5 Chives Blockchain 2021-05-09
...
## 1.1.4 Chives Blockchain 2021-05-04
...
## 1.1.3 Chives Blockchain 2021-05-01
...
## 1.1.2 Chives Blockchain 2021-04-24
...
## 1.1.1 Chives Blockchain 2021-04-21
...
## 1.1.0 Chives Blockchain 2021-04-21

### Added

- This fork release includes full transaction support for the Chives Blockchain. Transactions are still disabled until 5/3/2021 at 10:00AM PDT. It is hard to overstate how much work and clean up went into this release.
...
## 1.0.5 Chives Blockchain 2021-04-14
...
## 1.0.3 Chives Blockchain 2021-03-30

### Added

- This is a minor bug fix release for version 1.0.2
- You should review the [release notes for v1.0.2](https://github.com/HiveProject2021/chia-blockchain/releases/tag/1.0.2) but we especially want to point out that wallet sync is much faster than in 1.0.1 and earlier versions.
...
## 1.0.2 Chives Blockchain 2021-03-30

### Added

- We have released version 1.0.0 of [chiapos](https://github.com/HiveProject2021/chiapos). This includes a 20% speed increase for bitfield plotting compared to the previous version on the same machine. In many cases this will mean that bitfield plotting is as fast or faster than non bitfield plotting.
...
## 1.0.1 Chives Blockchain 2021-03-23
...
- This is the first production release of the Chives Blockchain. This can be installed and will wait for the green flag that will be dropped at approximately 7AM PDST (14:00 UTC) on Friday March 19, 2021. All farming rewards from that point forward will be considered valid and valuable XCC. There is a six week lock on all transactions. During those six weeks farmers will be earning their farming rewards but those rewards can not be spent.
...
- Migration with CHIVES_ROOT set does not crash chia init

## 1.0rc8 aka Release Candidate 8 - 2021-03-15

### Added

- This is a hard fork/breaking change from RC6/7. TXCC Coins will **not** be moved forward but your plots and keys and parts of your configuration do. When you install this version before 10AM PDST on 3/16/2021 it will load up, start finding peers, and otherwise wait for the flag drop at that time to start farming. This is likely to be the last dress rehearsal for mainnet launch. Our [3/15/2021 blog post](https://www.chia.net/2021/03/15/mainnet-update.html) has more details on the current mainnet launch plan.
...
- `chia farm summary` will now display TXCC or XCC as appropriate.
...
- Chives wheels not on Pypi and some dependecies not found there also are now on pypi.chia.net.
...
- The Farm page will now no longer get stuck at 50 TXCC farmed.
...
- The RC5 release is a new breaking change/hard fork blockchain. Plots and keys from previous chains will work fine on RC5 but balances of TXCC will not come forward.
...
- However, we have updated and test compiled all Chives dependencies on Apple Silicon and will be making available a test .dmg for MacOS ARM64 shortly.
...
- RC3 is a new chain to support the last major chialisp changes. TXCC from the RC1/2 chain do not come forward to this chain but plots and keys continue to work as usual.
...
- The entire CLI has been ported to [Click](https://click.palletsprojects.com/en/7.x/). Huge thanks to @jespino for the big assist and @unparalleled-js for the [recommendation and the initial start](https://github.com/HiveProject2021/chia-blockchain/issues/464). This will make building out the CLI much easier. There are some subtle changes and some shortcuts are not there anymore. `chia -h` and `chia SUBCOMMAND -h` can be your guide.
...
- This is an errata release for Release Candidate 1. There were a couple of things that did not smoothly migrate from the Beta versions. Please make sure you also consult the [release notes for RC-1](https://github.com/HiveProject2021/chia-blockchain/releases/tag/1.0rc1) was well.
...
- We have integrated with crowdin to make it easier to translate the GUI. Check out [Chives Blockchain GUI](https://crowdin.com/project/chia-blockchain) there.
- We have added Italian, Russian, and Finnish. More to come soon.
- There is now remote UI support. [Documents](https://github.com/HiveProject2021/chia-blockchain-gui/blob/main/remote.md) will temporarily live in the repository but have moved to the [wiki](https://github.com/HiveProject2021/chia-blockchain/wiki/Connecting-the-UI-to-a-remote-daemon). Thanks to @dkackman for this excellent addition!
...
- 'chia wallet send' now takes in TXCC or XCC as units instead of mojos.
...
- The cli wallet, `chia wallet`, was incorrectly displaying TXCC balances as if they were Coloured Coins.
...
- Significant improvements have been made to how the full node handles the mempool. This generally cuts CPU usage of node by 2x or more. Part of this increase is that we have temporarily limited the size of transactions. If you want to test sending a transaction you should keep the value of your transaction below 20 TXCC as new consensus will cause you to use a lot of inputs. This will be returned to the expected level as soon as the integration of [clvm rust](https://github.com/HiveProject2021/clvm_rs) is complete.
...
- We have made the "Help Translate" button in the GUI open in your default web browser and added instructions for adding new translations and more phrases in existing translations at that [URL](https://github.com/HiveProject2021/chia-blockchain/tree/main/electron-react/src/locales). Try the "Help Translate" option on the language selection pull down to the left of the dark/light mode selection at the top right of the GUI.
...
- We are down to only one sub dependency that does not ship binary wheels for all four platforms. The only platform still impacted is ARM64 (generally Raspberry Pi) but that only means that you still need the minor build tools as outlined on the [wiki](https://github.com/HiveProject2021/chia-blockchain/wiki/Raspberry-Pi).
...
- Last Attempted Proof is now fixed. This will show you the last time one of your plots passed the [plot filter](https://github.com/HiveProject2021/chives-blockchain/wiki/FAQ#what-is-the-plot-filter-and-why-didnt-my-plot-pass-it).
...
- Welcome to the new consensus. This release is an all but a full re-write of the blockchain in under 30 days. There is now only one tip of the blockchain but we went from two chains to three. Block times are now a little under a minute but there are a couple of sub blocks between each transaction block. A block is also itself a special kind of sub block and each sub block rewards the farmer who won it 1 TXCC. Sub blocks come, on average, about every 17 to 18 seconds.
- Starting with this Beta, there are 4608 opportunities per day for a farmer to win 1 TXCC compared to Beta 18 where there were 288 opportunities per day for a farmer to win 16 TXCC.
- There is a lot more information and explanation of the new consensus algorithm in the New Consensus Working Document linked from [chia.net](https://chia.net/). Among the improvements this gives the Chives blockchain are a much higher security level against all attacks, more frequent transaction blocks that have less time variation between them and are then buried under confirmations (sub blocks also count towards re-org security) much more quickly.
- New consensus means this is a very hard fork. All of your TXCC from Beta 17/18 will be gone. Your plots and keys will work just fine however. You will have to sync to the new chain.
...
- Prior to this Beta 19, we had block times that targeted 5 minutes and rewarded 16 TXCC to one farmer. Moving forward we have epoch times that target 10 minutes and reward 32 TXCC to 32 farmers about every 17-18 seconds over that period. This has subtle naming and UI impacts in various places.
...
- The Farm tab in the GUI is significantly enhanced. Here you have a dashboard overview of your farm and your activity in response to challenges blockchain challnegs, how long it will take you - on average - to win a block, and how much TXCC you've won so far. Harvester and Full Node connections have moved to Advanced Options.
- Harvester and farmer will start when the GUI starts instead of waiting for key selection if there are already keys available. This means you will start farming on reboot if you have the Chives application set to launch on start.
...
- RPCs and daemon now communicate over TLS with certificates that are generated into `~/.chives/VERSION/config/`
...
- A segfault caused by memory leaks in bls-library has been fixed. This should end the random farmer and harvester crashes over time as outlined in [Issue 500](https://github.com/HiveProject2021/chia-blockchain/issues/500).
...
- In the GUI there was [a regression](https://github.com/HiveProject2021/chia-blockchain/issues/484) that removed the scroll bar on the Plot page. The scroll bar has returned!
...
- Logging had [a regression](https://github.com/HiveProject2021/chia-blockchain/issues/485) where log level could no longer be set by service.
...
- The GUI now supports translations and localizations. If you'd like to add your language you can see the examples in [the locales directory](https://github.com/HiveProject2021/chia-blockchain/tree/dev/electron-react/src/locales) of the chia-blockchain repository.
...
- Updated to chiapos 0.12.32. This update significantly speeds up the F1/first table plot generation. It also now can log disk usage while plotting and generate graphs. More details in the [chiapos release notes](https://github.com/HiveProject2021/chiapos/releases/tag/0.12.32).
...
- You can now backup your wallet related metadata in an encrypted and signed file to a free service from Chives Network at backup.chia.net. Simply having a backup of your private key will allow you to fully restore the state of your wallet including coloured coins, rate limited wallets, distributed identity wallets and many more. Your private key is used to automatically restore the last backup you saved to the Chives backup cloud service. This service is open source and ultimately you will be able to configure your backups to go to backup.chia.net, your own installation, or a third party's version of it.
...
- In Windows the start menu item is now Chives Network and the icon in Add/Remove is updated.

## [1.0beta11] aka Beta 1.11 - 2020-08-24

### Added

- The Chives UI now has a proper About menu entry that gives the various component versions and directs people to submit issues on GitHub. Thank you to @freddiecoleman for this pull request!
...
are read.
- Updated [blspy](https://github.com/HiveProject2021/bls-signatures) to use the
...
- Changed XCC units to TXCC units for testnet.
...
- The Windows installer is now signed by a Chives Network certificate. It may take some time to develop enough reputation to not warn multiple times during install.
...
- Test plots for the simulation and testing harness now go into `~/.chives/test-plots/`
- We have completely refactored all networking code towards making each Chives service use the same default networking infrastructure and move to websockets as the default networking wire protocol.
...
- We now codesign the Apple .dmg installer with the Chives Network developer ID on both GitHub Actions and Azure Pipelines. We will be notarizing and distributing the Azure Pipelines version as it's built on MacOS Mojave (10.14.6) for stronger cross version support.
...
- The user interface now refers to chia coins with their correct currency code of XCC.
...
- Most of the content of README.md and INSTALL.md have been moved to the [repository wiki](https://github.com/HiveProject2021/chia-blockchain/wiki) and placed in [INSTALL](https://github.com/HiveProject2021/chia-blockchain/wiki/INSTALL) and [Quick Start Guide](https://github.com/HiveProject2021/chia-blockchain/wiki/Quick-Start-Guide)
...
- Chives start commands like `chia start farmer` and `chia stop node` now keep track of process IDs in a run/ directory in your configuration directory. `chia stop` is unlikely to work on Windows native for now. If `chia start -r node` doesn't work you can force the run/ directory to be reset with `chia start -f node`.
- We suggest you take a look at our [Upgrading documentation](https://github.com/HiveProject2021/chia-blockchain/wiki/Updating-beta-software) if you aren't performing a new install.
...
- Plots of k>=32 are not working for farming, and some broken plots can cause a memory leak. A [workaround is available](https://github.com/HiveProject2021/chia-blockchain/wiki/Beta-1.4-k=32-or-larger-work-around).
...
- There is a new command `chia init` that will migrate files and generate your initial configuration. If you want to use the Wallet or farm, you will also have to `chia-generate-keys`. You can read step by step instructions for [upgrading from a previous beta release](https://github.com/HiveProject2021/chia-blockchain/wiki/Updating-beta-software). If you've set `$CHIVES_ROOT` you will have to make sure your existing configuration remains compatible manually.
...
- If you previously used the plot_root variable in config, your plot directory names might not migrate correctly. Please double check the filenames in `~/.chives/beta-1.0b3/config/plots.yaml` after migrating
...
- We have revamped the chia management command line. To start a farmer all you have to do is start the venv with `. ./activate` and then type `chia-start-farmer &`. The [README.md](https://github.com/HiveProject2021/chia-blockchain/blob/main/README.md) has been updated to reflect the new commands.
...
- Configuration directories have been moved to a default location of HomeDirectory/.chives/release/config, plots/ db/, wallet/ etc. This can be overridden by `export CHIVES_ROOT=~/.chia` for example which would then put the plots directory in `HomeDirectory/.chives/plots`.
- The libraries chia-pos, chia-fast-vdf, and chia-bip-158 have been moved to their own repositories: [chiapos](https://github.com/HiveProject2021/chiapos), [chiavdf](https://github.com/HiveProject2021/chiavdf), and [chaibip158](https://github.com/HiveProject2021/chiabip158). They are brought in by chia-blockchain at install time. Our BLS signature library remains at [bls-signatures](https://github.com/HiveProject2021/bls-signatures).
...
- Chives fullnode, farmer and harvester now default to logging to chia.log in the chia-blockchain directory. This is configured in config.yaml and due to config.yaml changes it is recommended to edit the new template config instead of using older config.yaml’s from previous versions.
...
- VDF improvements - VDF verification and generation speed has increased and dependence on flint2 has been removed. We wish to thank Dr. William Hart (@wbhart) for dual licensing parts of his contributions in FLINT and Antic for inclusion in the Chives blockchain.
...
- This is the first release of the Chives testnet! Blockchain consensus, proof of time, and proof of space are included.
- More details on the release at [https://www.chia.net/developer/](https://www.chia.net/developer/)

[unreleased]: https://github.com/HiveProject2021/chia-blockchain/compare/1.0beta5...dev
[1.0beta5]: https://github.com/HiveProject2021/chia-blockchain/compare/1.0beta4...1.0beta5
[1.0beta4]: https://github.com/HiveProject2021/chia-blockchain/compare/1.0beta3...1.0beta4
[1.0beta3]: https://github.com/HiveProject2021/chia-blockchain/compare/1.0beta2...1.0beta3
[1.0beta2]: https://github.com/HiveProject2021/chia-blockchain/compare/1.0beta1...1.0beta2
[1.0beta1]: https://github.com/HiveProject2021/chia-blockchain/compare/alpha-1.5.1...1.0beta1
[alpha 1.5.1]: https://github.com/HiveProject2021/chia-blockchain/compare/alpha-1.5...alpha-1.5.1
[alpha 1.5]: https://github.com/HiveProject2021/chia-blockchain/compare/alpha-1.4.1...alpha-1.5
[alpha 1.4.1]: https://github.com/HiveProject2021/chia-blockchain/compare/alpha-1.4...alpha-1.4.1
[alpha 1.4]: https://github.com/HiveProject2021/chia-blockchain/compare/alpha-1.3...alpha-1.4
[alpha 1.3]: https://github.com/HiveProject2021/chia-blockchain/compare/alpha-1.2...alpha-1.3
[alpha 1.2]: https://github.com/HiveProject2021/chia-blockchain/compare/alpha-1.1.1...alpha-1.2
[alpha 1.1.1]: https://github.com/HiveProject2021/chia-blockchain/compare/alpha-1.1...alpha-1.1.1
[alpha 1.1]: https://github.com/HiveProject2021/chia-blockchain/compare/alpha-1.0...alpha-1.1
[alpha 1.0]: https://github.com/HiveProject2021/chia-blockchain/releases/tag/Alpha-1.0
