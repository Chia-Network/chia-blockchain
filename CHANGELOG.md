...
Farmers rejoice: today's release integrates two plotters in broad use in the Chinilla community: Bladebit, created by @harold-b, and Madmax, created by @madMAx43v3r. Both of these plotters bring significant improvements in plotting time. More plotting info [here](https://github.com/Chinilla/chinilla-blockchain/wiki/Alternative--Plotters).
...
- Performance improvements for nodes to support higher transaction volumes, especially for low powered devices like RaspBerry Pi. Full details at [#9050](https://github.com/Chinilla/chinilla-blockchain/pull/9050).
...
- Integrated the Bladebit plotter to CLI and GUI. Thanks @harold-b for all your hard work on this, and welcome again to the Chinilla Network team!
- Added the Madmax plotter to CLI and GUI. Thanks @madMAx43v3r for your support!
- Added option to configure your node to testnet using to `chinilla init --testnet`.
...
We have some great improvements in this release: We launched our migration of keys to a common encrypted keyring.yaml file, and we secure this with an optional passphrase in both GUI and CLI. We've added a passphrase hint in case you forget your passphrase. More info on our [wiki](https://github.com/Chinilla/chinilla-blockchain/wiki/Passphrase-Protected-Chinilla-Keys-and-Key-Storage-Migration). We also launched a new Chinillalisp compiler in clvm_tools_rs which substantially improves compile time for Chinillalisp developers. We also addressed a widely reported issue in which a system failure, such as a power outage, would require some farmers to sync their full node from zero. This release also includes several other improvements and fixes.

### Added

- Added support for keyring migration from keychain, and the addition of passphrase support. Learn more at our [wiki](https://github.com/Chinilla/chinilla-blockchain/wiki/Passphrase-Protected-Chinilla-Keys-and-Key-Storage-Migration).
- Enabled experimental use of a new Chinillalisp compiler in clvm_tools_rs in chinilla-blockchain, which is off by default, and substantially improves compile time.
...
- Thanks @cross for change that allows using IPv6 address in config.yaml for remote harvesters and other chinilla services.
...
- Updated the old comment on chinilla/util/streamable.py with newer developer documentation.
...
- Thanks @jcteng for fixing a bug on the Chinilla DID wallet that showed 'chin:'' instead of 'chin'.

## 1.2.9 Chinilla blockchain 2021-10-01

### Changed

- Changed "About" section in client to indicate correct release version.

## 1.2.8 Chinilla blockchain 2021-09-30
...
- Added support for DID, our decentralized identity solution, as a building block toward Chinilla's broader set of DID capabilities.
...
- Several clvm_rs updates to support our upcoming Chinilla Asset Token (CAT) standard.
...
## 1.2.3 Chinilla blockchain 2021-07-26
...
## 1.2.2 Chinilla blockchain 2021-07-13
...
## 1.2.1 Chinilla blockchain 2021-07-12
...
## 1.2.0 Chinilla blockchain 2021-07-07
...
### 1.1.7 Chinilla Blockchain 2021-06-05
...
## 1.1.6 Chinilla Blockchain 2021-05-20
...
## 1.1.5 Chinilla Blockchain 2021-05-09
...
## 1.1.4 Chinilla Blockchain 2021-05-04
...
## 1.1.3 Chinilla Blockchain 2021-05-01
...
- Mitigate 1-3 chin dust attacks.
...
## 1.1.2 Chinilla Blockchain 2021-04-24
...
## 1.1.1 Chinilla Blockchain 2021-04-21
...
## 1.1.0 Chinilla Blockchain 2021-04-21

### Added

- This fork release includes full transaction support for the Chinilla Blockchain. Transactions are still disabled until 5/3/2021 at 10:00AM PDT. It is hard to overstate how much work and clean up went into this release.
- This is the 1.0 release of Chinillalisp. Much has been massaged and finalized. We will be putting a focus on updating and expanding the documentation on [chinillalisp.com](https://chinillalisp.com) shortly.
...
## 1.0.5 Chinilla Blockchain 2021-04-14
...
## 1.0.4 Chinilla Blockchain 2021-04-12
...
- The `src` directory in chinilla-blockchain has been changed to `chinilla` to avoid namespace collisions.
- GUI install builds have been simplified to rely on one `.spec` file in `chinilla/`
...
## 1.0.3 Chinilla Blockchain 2021-03-30

### Added

- This is a minor bug fix release for version 1.0.2
- You should review the [release notes for v1.0.2](https://github.com/Chinilla/chinilla-blockchain/releases/tag/1.0.2) but we especially want to point out that wallet sync is much faster than in 1.0.1 and earlier versions.

### Fixed

- An incorrect merge brought in unreleased features and broke `chinilla keys`.
- Omitted from the 1.0.2 changelog, we fixed one crash in harvester with the release of chiapos 1.0.0 as well.

## 1.0.2 Chinilla Blockchain 2021-03-30

### Added

- We have released version 1.0.0 of [chiapos](https://github.com/Chinilla/chiapos). This includes a 20% speed increase for bitfield plotting compared to the previous version on the same machine. In many cases this will mean that bitfield plotting is as fast or faster than non bitfield plotting.
...
- We have added Dutch and Polish to supported translations. Thanks @psydafke, @WesleyVH, @pieterhauwaerts, @bartlomiej.tokarzewski, @abstruso, @feel.the.code, and @Axadiw for contributions to [translations on Crowdin](https://crowdin.com/project/chinilla-blockchain).
...
- @jespino changed `chinilla keys show` to require the `--show-mnemonic-seed` before it displays your 24 work private key mnemonic.
- We decreased the size of the block cache in node to perform better with longer chains.
- You can now add a private key mnemonic from a file with `chinilla keys show`.
...
## 1.0.1 Chinilla Blockchain 2021-03-23

### Added

- There is now a simple progress bar on the GUI Plot page and when you view the log from the three dots on the right.
- Users must now explicitly set the `--show-mnemonic-seed` flag to see their private keys when running `chinilla keys show`.
- We are now building Linux GUI installers. These should be considered beta quality for now.
- Translations now available for German, Traditional Chinese, and Danish. Thanks to @Dravenex, @MaestroOnICe, @loudsyncro, @loppefaaret, @thirteenthd, @wong8888, @N418, and @swjz for all the translation help. You to can translate at our [Crowdin project](https://crowdin.com/project/chinilla-blockchain/).

### Changed

- The vanillanet genesis is now in the initial config.yaml and the green flag components have been removed.
...
- This vanillanet release does not migrate previous testnet configuration files.

### Fixed

- Weight proofs, especially wallet weight proofs were failing when some Blueboxed proofs of time were encountered.
- Users can now pip install e.g. chinilla-blockchain==1.0.1 on most platforms.
- Sometimes the GUI had an error regarding MainWindow.

## 1.0.0 First Release of Chinilla Blockchain 2021-03-17

### Added

- This is the first production release of the Chinilla Blockchain. This can be installed and will wait for the green flag that will be dropped at approximately 7AM PDST (14:00 UTC) on Friday March 19, 2021. All farming rewards from that point forward will be considered valid and valuable XCHI. There is a six week lock on all transactions. During those six weeks farmers will be earning their farming rewards but those rewards can not be spent.
...
- Thank you to @L3Sota for adding a Japanese translation via our [Crowdin project](https://crowdin.com/project/chinilla-blockchain).
...
- Vanillanet uses port 42444 and other constants and service names were changed for vanillanet.
...
- `chinilla farm summary` will now display TXCHI or XCHI as appropriate.
...
- The Farm page will now no longer get stuck at 50 TXCHI farmed.
...
- We believe that the install/migrate process was bringing forward bad farming rewards receive addresses. We have attempted to stop that by only migrating RC3 and newer configurations. You can make sure you are not effected by using the Manage Farming Rewards tool mentioned above or putting a known good wallet receive address in both `xchi_target_address` sections of config.yaml.
...
- RC3 is a new chain to support the last major chinillalisp changes. TXCHI from the RC1/2 chain do not come forward to this chain but plots and keys continue to work as usual.
...
- A new RPC api: /push_tx. Using this RPC, you can spend custom chinillalisp programs. You need to make a SpendBundle, which includes the puzzle reveal (chinillalisp), a solution (chinillalisp) and a signature.
- You can now use the RPC apis to query the mempool.
- There are now Swedish, Spanish, and Slovak translations. Huge thanks to @ordtrogen (Swedish), @jespino and @dvd101x (Spanish), and our own @seeden (Slovak). Also thanks were due to @f00b4r (Finnish), @A-Caccese (Italian), and @Bibop182 and @LeonidShamis (Russian). Quite a few more are almost complete and ready for inclusion. You can help translate and review translations at our [crowdin project](https://crowdin.com/project/chinilla-blockchain).
- You can obtain a new wallet receive address on the command line with `chinilla wallet new_address`. Thanks to @jespino for this and a lot more in the next section below.
- You will now see Your Harvester Network in the GUI even if you have no plots.

### Changed

- All chinillalisp opcodes have been renumbered. This should be the last major breaking change for chinillalisp and the clvm. There are a couple minor enhancements still needed for vanillanet launch, but they may or may not require minor breaking changes. We will be restarting testnet chains on a mostly weekly basis either way.
- Node batch syncing performance was increased, and it now avoids re-validating blocks that node had already validated.
- The entire CLI has been ported to [Click](https://click.palletsprojects.com/en/7.x/). Huge thanks to @jespino for the big assist and @unparalleled-js for the [recommendation and the initial start](https://github.com/Chinilla/chinilla-blockchain/issues/464). This will make building out the CLI much easier. There are some subtle changes and some shortcuts are not there anymore. `chinilla -h` and `chinilla SUBCOMMAND -h` can be your guide.
...
- `chinilla plots check` now will continue checking after it finds an error in a plot to the total number of checks you specified.
...
- The application is now more aware of whether it is running a testnet or vanillanet. This impacts wallet's display behavior and certain blockchain validation rules.
- Interface improvements for `chinilla netspace`.
- Now that aiosqlite included our upstream improvements we install version 0.17.0.
- `chinilla init` only migrates release candidate directories. The versioned sub directories under `~/chinilla` will be going away before vanillanet.
...
- `chinilla configure -log-level` was broken.
...
- This is an errata release for Release Candidate 1. There were a couple of things that did not smoothly migrate from the Beta versions. Please make sure you also consult the [release notes for RC-1](https://github.com/Chinilla/chinilla-blockchain/releases/tag/1.0rc1) was well.
...
- This is the first release in our release candidate series. There are still a few things that will change at the edges but the blockchain, clvm, and chinillalisp are in release form. We have one major change to chinillalisp/clvm that we have chosen to schedule for the next release as in this release we're breaking the way q/quote works. We also have one more revision to the VDF that will decrease the sizes of the proofs of time. We expect a few more releases in the release candidate series.
- Installers will now be of the pattern ChinillaSetup-0.2.1.exe. `0.2` is release candidate and the final `.1` is the first release candidate.
- Use 'chinilla wallet get_transactions' in the command line to see your transactions.
- 'chinilla wallet show' now shows your wallet's height.
...
- We have integrated with crowdin to make it easier to translate the GUI. Check out [Chinilla Blockchain GUI](https://crowdin.com/project/chinilla-blockchain) there.
- We have added Italian, Russian, and Finnish. More to come soon.
- There is now remote UI support. [Documents](https://github.com/Chinilla/chinilla-blockchain-gui/blob/main/remote.md) will temporarily live in the repository but have moved to the [wiki](https://github.com/Chinilla/chinilla-blockchain/wiki/Connecting-the-UI-to-a-remote-daemon). Thanks to @dkackman for this excellent addition!
...
- 'chinilla wallet send' now takes in TXCHI or XCHI as units instead of chins.
...
- The Beta 27 chain is a hard fork. All TXCHI from previous releases has been reset on this chain. Your keys and plots of k=32 or larger continue to work just fine on this new chain.
...
- We have added the [Crowdin](https://crowdin.com/) translation platform to [chinilla blockchain gui](https://crowdin.com/project/chinilla-blockchain). We are still getting it fully set up, but helping to translate the GUI is going to be much easier.
...
- This release has the final vanillanet rewards schedule. During the first three years, each block winner will win 2 TXCHI/XCHI per block for a total of 9216 TXCHI per day from 4608 challenges per day.
- Smart transactions now use an announcement instead of 'coin consumed' or lock methods.
- The GUI is now in a separate submodule repository from chinilla-blockchain, [chinilla-blockchain-gui](https://github.com/Chinilla/chinilla-blockchain-gui). The installers and install scripts have been updated and it continues to follow the same install steps. Note that the GUI directory will now be `chinilla-blockchain-gui`. The workflow for this may be "touch and go" for people who use the git install methods over the short term.
...
- The cli wallet, `chinilla wallet`, was incorrectly displaying TXCHI balances as if they were Coloured Coins.
...
- `chinilla plots check -l` will list all duplicate plot IDs found on the machine. Thanks very much for this PR @eFishCent.

### Changed

- Significant improvements have been made to how the full node handles the mempool. This generally cuts CPU usage of node by 2x or more. Part of this increase is that we have temporarily limited the size of transactions. If you want to test sending a transaction you should keep the value of your transaction below 20 TXCHI as new consensus will cause you to use a lot of inputs. This will be returned to the expected level as soon as the integration of [clvm rust](https://github.com/Chinilla/clvm_rs) is complete.
- We have changed the way TLS between nodes and between chinilla services work. Each node now has two certificate authorities. One is a public, shared CA that signs the TLS certificates that every node uses to connect to other nodes on 42444 or 43444. You now also have a self generated private CA that must sign e.g. farmer and harvester's certificates. To run a remote harvester you need a new harvester key that is then signed by your private CA. We know this is not easy for remote harvester in this release but will address it quickly.
...
- We have made the "Help Translate" button in the GUI open in your default web browser and added instructions for adding new translations and more phrases in existing translations at that [URL](https://github.com/Chinilla/chinilla-blockchain/tree/main/electron-react/src/locales). Try the "Help Translate" option on the language selection pull down to the left of the dark/light mode selection at the top right of the GUI.
- Sync store now tracks all connected peers and removes them as they get removed.
- The Rate Limited Wallet has been ported to new consensus and updated Chinillalisp methods.
- We are down to only one sub dependency that does not ship binary wheels for all four platforms. The only platform still impacted is ARM64 (generally Raspberry Pi) but that only means that you still need the minor build tools as outlined on the [wiki](https://github.com/Chinilla/chinilla-blockchain/wiki/Raspberry-Pi).
...
- Last Attempted Proof is now fixed. This will show you the last time one of your plots passed the [plot filter](https://github.com/Chinilla/chinilla-blockchain/wiki/FAQ#what-is-the-plot-filter-and-why-didnt-my-plot-pass-it).
...
- `chinilla plots check` enforces a minimum of `-n 5` to decrease false negatives. Thanks to @eFishCent for these ongoing pull requests!
- Testnets and vanillanets will now have an initial period of sub blocks where transactions are blocked.
...
- clvm bytecode is now generated and confirmed that the checked-in clvm and ChinillaLisp code matches the CI compiled code.
- We have removed the '-r' flag from `chinilla` as it was being overridden in most cases by the `-r` for restart flag to `chinilla start`. Use `chinilla --root-path` instead.
- `chinilla -h` now recommends `chinilla netspace -d 192` which is approximately one hours worth of sub blocks. Use `-d 1000` to get the same estimate of netspace as the RPC and GUI.
- `chinilla show -c` now displays in MiB and the GUI has been changed to MiB to match.
- `chinilla configure` now accepts the shorter `-upnp` and `-log-level` arguments also.
- `chinilla plots check` now defaults to `-n 30` instead of `-n 1` - HT @eFishCent.
- `chinilla plots create` now enforces a minimum of k=22. As a reminder, anything less than k=32 is just for testing and be careful extrapolating performance of a k less than 30 to a k=32 or larger.
...
- `chinilla show -c` was showing upload MiB in the download column and vice versa. @pyl and @psydafke deserves credit for insisting it was broken and @kd637xx for the PR assist.
- `chinilla show` handles sub block 0 better.
...
- `chinilla plots create -x` skips adding [final dir] to harvester for farming
...
- Removed loading plot file names when starting `chinilla plots create`; decreases plotter time when there are a lot of plots on the machine. Huge thanks to @eFishCent for this PR!
...
- `chinilla show -h` now correctly states that you use the first 8 characters of the node id to remove a node on the cli.
- Thank you to @wallentx for adding better help for `chinilla configure --enable-upnp`.
...
- `chinilla configure` now lets you enable or disable uPnP.
...
- `chinilla netspace -s` would not correctly look up the start block height by block hash. Additionally netspace now flips to PiB above 1024 TiB. To compare netspace to `chinilla show` of the GUI use `chinilla netspace -d 1000` as `chinilla netspace` defaults to `-d 192` which is one hour.
...
- The Farm tab in the GUI is significantly enhanced. Here you have a dashboard overview of your farm and your activity in response to challenges blockchain challnegs, how long it will take you - on average - to win a block, and how much TXCHI you've won so far. Harvester and Full Node connections have moved to Advanced Options.
...
- Testnet is now running at the primary port of 43444. Update your routers appropriately. This opens 42444 for vanillanet.
...
- Changes were made to chiapos to correctly support the new bitfiled backpropogation on FreeBSD and OpenBSD. With the exception of needing to work around python cryptography as outlined on the wiki, FreeBSD and OpenBSD should be able to compile and run chinilla-blockchain.
...
- Updated to chiapos 0.12.32. This update significantly speeds up the F1/first table plot generation. It also now can log disk usage while plotting and generate graphs. More details in the [chiapos release notes](https://github.com/Chinilla/chiapos/releases/tag/0.12.32).
...
- Changed XCHI units to TXCHI units for testnet.
...
other chains.
- Keys are now derived with the EIP 2334 (m/12381/42444/a/b).
...
- We added [lgtm](https://lgtm.com/) source analysis on pull request to the chinilla-blockchain, chiapos, chiavdf, chiabip158, and bls-library repositories to add some automated security analysis to our ci.
...
- We have added an option to `chinilla-create-plots` to specify the second temporary directory. Creating a plot is a three step process. First a working file ending in `.dat.tmp` is created. This file is usually 5 times larger than the final plot file. In the later stages of plotting a second temp file is created ending in `.dat.2.tmp` which will grow to the size of the final plot file. In the final step, the `.dat.2.tmp` is copied to the final `.dat` plot file. You can now optionally set the directory for the `.dat.2.tmp` file with the `-2` flag. An example use case is plotting on a ramdisk and writing both the second temp file and the final file out to an SSD - `chinilla-create-plots -n 1 -k 30 -t /mnt/ramdisk -2 /mnt/SSD -d /mnt/SSD`.

### Changed

- `chinilla init` properly migrates from previous versions including the k>=32 workaround. Additionally, the farming target key is checked to make sure that it is the valid and correct public key format.
- We have implemented a workaround for the `chinilla start` issues some were having upon crash or reboot. We will be rebuilding start and stop to be robust across platforms.
- This release re-includes `chinilla-start-harvester`.
...
- The user interface now refers to chinilla coins with their correct currency code of XCHI.
...
- There was a regression in Chinilla Proof of Space ([chiapos](https://github.com/Chinilla/chiapos)) that came from our efforts to speed up plotting on Windows native. Now k>=32 plots work correctly. We made additional bug fixes and corrected limiting small k size generation.
- There was a bug in Timelord handling that could stop all VDF progress.

### Deprecated

- We have made significant changes to the full node database to make it more reliable and quicker to restart. This requires re-syncing the current chain. If you use `chinilla init` then sync on first start will happen automatically. "\$CHINILLA_ROOT" users will need to delete `$CHINILLA_ROOT/db/*` before starting Beta 1.5. This also fixes the simulation issue in Beta 1.4 where tips could go "back in time."
...
- Now you can run estimates of the total space currently farming the network. Try `chinilla netspace -d 12` to run an estimate over the last 12 blocks which is approximately 1 hour.
- We’ve added TLS authentication for incoming farmer connections. TLS certs and keys are generated during chinilla init and only full nodes with your keys will be able to connect to your Farmer. Also, Harvester, Timelord, and Wallet will now not accept incoming connections which reduces the application attack surface.
- The node RPC has a new endpoint get_header_by_height which allows you to retrieve the block header from a block height. Try `chinilla show -bh 1000` to see the block header hash of block 1000. You can then look up the block details with `chinilla show -b f655e1a9f7f8c89a703e40d9ce82ae33508badaf7b37fa1a56cad27926b5e936` which will look up a block by it's header hash.
...
- Most of the content of README.md and INSTALL.md have been moved to the [repository wiki](https://github.com/Chinilla/chinilla-blockchain/wiki) and placed in [INSTALL](https://github.com/Chinilla/chinilla-blockchain/wiki/INSTALL) and [Quick Start Guide](https://github.com/Chinilla/chinilla-blockchain/wiki/Quick-Start-Guide)
...
- Most scripts have been removed in favor of chinilla action commands. You can run `chinilla version` or `chinilla start node` for example. Just running `chinilla` will show you more options. However `chinilla-create-plots` continues to use the hyphenated form. Also it's now `chinilla generate keys` as another example.
- Chinilla start commands like `chinilla start farmer` and `chinilla stop node` now keep track of process IDs in a run/ directory in your configuration directory. `chinilla stop` is unlikely to work on Windows native for now. If `chinilla start -r node` doesn't work you can force the run/ directory to be reset with `chinilla start -f node`.
- We suggest you take a look at our [Upgrading documentation](https://github.com/Chinilla/chinilla-blockchain/wiki/Updating-beta-software) if you aren't performing a new install.
...
- The script `chinilla start wallet-gui` has been chaned to `chinilla start wallet` which launches but the GUI and server on MacOS and Linux. `chinilla start wallet-server` remains for WSL 2 and Windows native.
...
- Plots of k>=32 are not working for farming, and some broken plots can cause a memory leak. A [workaround is available](https://github.com/Chinilla/chinilla-blockchain/wiki/Beta-1.4-k=32-or-larger-work-around).
...
- Currently, there is no way to restore a Coloured Coin Wallet.
- The `chinilla stop all` command sometimes fails, use `chinilla-stop-all` instead. In windows, use the task manager to stop the servers.
...
- There is a new command `chinilla init` that will migrate files and generate your initial configuration. If you want to use the Wallet or farm, you will also have to `chinilla-generate-keys`. You can read step by step instructions for [upgrading from a previous beta release](https://github.com/Chinilla/chinilla-blockchain/wiki/Updating-beta-software). If you've set `$CHINILLA_ROOT` you will have to make sure your existing configuration remains compatible manually.
...
- We added full block lookup to `chinilla show`.

### Changed

- `chinilla-restart-harvester` has been renamed from `chinilla-start-harvester` to better reflect its functionality. Use it to restart a harvester that's farming so that it will pick up newly finished plots.
...
- If you previously used the plot_root variable in config, your plot directory names might not migrate correctly. Please double check the filenames in `~/.chinilla/beta-1.0b3/config/plots.yaml` after migrating
...
- There is now full transaction support on the Chinilla blockchain. In this initial Beta 1.0 release, all transaction types are supported though the wallets and UIs currently only directly support basic transactions like coinbase rewards and sending coins while paying fees. UI support for our [smart transactions](https://github.com/Chinilla/wallets/blob/main/README.md) will be available in the UIs shortly.
...
- We have revamped the chinilla management command line. To start a farmer all you have to do is start the venv with `. ./activate` and then type `chinilla-start-farmer &`. The [README.md](https://github.com/Chinilla/chinilla-blockchain/blob/main/README.md) has been updated to reflect the new commands.
...
- Configuration directories have been moved to a default location of HomeDirectory/.chinilla/release/config, plots/ db/, wallet/ etc. This can be overridden by `export CHINILLA_ROOT=~/.chinilla` for example which would then put the plots directory in `HomeDirectory/.chinilla/plots`.
- The libraries chinilla-pos, chinilla-fast-vdf, and chinilla-bip-158 have been moved to their own repositories: [chiapos](https://github.com/Chinilla/chiapos), [chiavdf](https://github.com/Chinilla/chiavdf), and [chaibip158](https://github.com/Chinilla/chiabip158). They are brought in by chinilla-blockchain at install time. Our BLS signature library remains at [bls-signatures](https://github.com/Chinilla/bls-signatures).
...
- `chinilla-regenerate-keys` has been renamed `chinilla-generate-keys`.
...
- New AJAX based full node UI. To access go to [http://127.0.0.1:42555/index.html](http://127.0.0.1:42555/index.html) with any modern web browser on the same machine as the full node.
...
- Chinilla fullnode, farmer and harvester now default to logging to chinilla.log in the chinilla-blockchain directory. This is configured in config.yaml and due to config.yaml changes it is recommended to edit the new template config instead of using older config.yaml’s from previous versions.
...
- VDF improvements - VDF verification and generation speed has increased and dependence on flint2 has been removed. We wish to thank Dr. William Hart (@wbhart) for dual licensing parts of his contributions in FLINT and Antic for inclusion in the Chinilla blockchain.
- Implemented an RPC interface with JSON serialization for streamables - currently on port 42555.
- Added details on how to contribute in CONTRIBUTING.md. Thanks @RichardLitt.
- Added color logging
- Now chinilla_harvester will periodically announce which plots it is currently farming and their k sizes.

### Changed

- Moved the ssh UI to use RPC.
- Changed the displayed process names for harvester, farmer, fullnode, timelords, and VDFs to to chinilla_full node, chinilla_harvester, etc. Fixed a bug that could cause inadvertent shutdown of other processes like an ongoing plotting session when new chinilla services were started.
...
- Introducer now makes sure it only sends peer addresses to peers of peers that it can reach on port 42444 or their UPnP port.
...
[1.0beta4]: https://github.com/Chinilla/chinilla-blockchain/compare/1.0beta3...1.0beta4
[1.0beta3]: https://github.com/Chinilla/chinilla-blockchain/compare/1.0beta2...1.0beta3
[1.0beta2]: https://github.com/Chinilla/chinilla-blockchain/compare/1.0beta1...1.0beta2
[1.0beta1]: https://github.com/Chinilla/chinilla-blockchain/compare/alpha-1.5.1...1.0beta1
[alpha 1.5.1]: https://github.com/Chinilla/chinilla-blockchain/compare/alpha-1.5...alpha-1.5.1
[alpha 1.5]: https://github.com/Chinilla/chinilla-blockchain/compare/alpha-1.4.1...alpha-1.5
[alpha 1.4.1]: https://github.com/Chinilla/chinilla-blockchain/compare/alpha-1.4...alpha-1.4.1
[alpha 1.4]: https://github.com/Chinilla/chinilla-blockchain/compare/alpha-1.3...alpha-1.4
[alpha 1.3]: https://github.com/Chinilla/chinilla-blockchain/compare/alpha-1.2...alpha-1.3
[alpha 1.2]: https://github.com/Chinilla/chinilla-blockchain/compare/alpha-1.1.1...alpha-1.2
[alpha 1.1.1]: https://github.com/Chinilla/chinilla-blockchain/compare/alpha-1.1...alpha-1.1.1
[alpha 1.1]: https://github.com/Chinilla/chinilla-blockchain/compare/alpha-1.0...alpha-1.1
[alpha 1.0]: https://github.com/Chinilla/chinilla-blockchain/releases/tag/Alpha-1.0
