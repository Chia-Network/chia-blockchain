...
This release also includes several important performance improvements, with two goals in mind: make sure everyone can farm at all times, and improve how many transactions per second each node can accept, especially for low-end hardware.
...
- We added command line support for adding fees Pooling NFTs, but which is not yet operable.  
