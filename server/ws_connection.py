...
from shitcoin.cmds.init_funcs import shitcoin_full_version_str
from shitcoin.protocols.protocol_message_types import ProtocolMessageTypes
from shitcoin.protocols.protocol_state_machine import message_response_ok
from shitcoin.protocols.protocol_timing import INTERNAL_PROTOCOL_ERROR_BAN_SECONDS
from shitcoin.protocols.shared_protocol import Capability, Handshake
from shitcoin.server.outbound_message import Message, NodeType, make_msg
from shitcoin.server.rate_limits import RateLimiter
...
from shitcoin.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSshitcoinConnection:
    """
