...
Read this for harvester-to-farmer plot inventory replication, plot-sync ACK/retry behavior, farmer-side plot list state, and UI/RPC plot-count correctness. For local plot discovery/load rules, read `chia-plotting.md`; for farmer proof handling, read `chia-farmer.md`.
