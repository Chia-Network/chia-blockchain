...
Read this for CLI tests, command parser behavior, mocked RPC-client tests, command output expectations, transaction-output files, and command framework coverage. For CLI implementation context, also read `chia-cmds.md`.
