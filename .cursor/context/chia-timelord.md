...
Read this for timelord VDF scheduling, peak/unfinished-block selection, VDF-client communication, compact proof production, timelord metrics, and full-node/timelord protocol coupling. For final block or VDF acceptance, also read `chia-full-node.md` and `chia-consensus.md`.
