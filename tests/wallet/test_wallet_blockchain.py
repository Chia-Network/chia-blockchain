...
class TestWalletBlockchain:
    ...
    async def test_wallet_blockchain(self, wallet_node, default_1000_blocks):
        ...
        async with DBConnection(1) as db_wrapper:
            ...
            assert await chain.get_finished_sync_up_to() == 0
            ...
            assert await chain.get_finished_sync_up_to() == 499
            assert chain.get_latest_timestamp() > 0
            ...
            assert await chain.get_finished_sync_up_to() == 505
            ...
            for block in header_blocks[506:]:
                ...
                assert await chain.get_finished_sync_up_to() == block.height

            assert await chain.get_finished_sync_up_to() == 999
