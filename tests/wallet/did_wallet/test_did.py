...
class TestDIDWallet:
    ...
    @pytest.mark.anyio
    async def test_did_resync(self, self_hostname, two_not_started_wallet_nodes, trusted) -> None:
        ...
        async with contextlib.AsyncExitStack() as exit_stack:
            ...
            await time_out_assert_not_none(
                5, full_node_api.full_node.mempool_manager.get_spendbundle, spend_bundle.name()
            )
            await full_node_api.farm_blocks_to_wallet(1, wallet2)
            await time_out_assert(15, did_wallet_1.get_confirmed_balance, 101)
            await time_out_assert(15, did_wallet_1.get_unconfirmed_balance, 101)
