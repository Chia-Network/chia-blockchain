...
async def wallet_node():
    async for _ in setup_simulators_and_wallets(1, 1, {}, starting_height=1):
        yield _
...
async def two_wallet_nodes():
    async for _ in setup_simulators_and_wallets(1, 2, {}, starting_height=1):
        yield _
...
async def three_sim_two_wallets():
    async for _ in setup_simulators_and_wallets(3, 2, {}, starting_height=1):
        yield _
