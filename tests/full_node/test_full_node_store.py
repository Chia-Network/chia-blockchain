...
class TestFullNodeStore:
    ...
    async def test_basic_store(self, empty_blockchain):
        ...
        for i in range(1, test_constants.NUM_SPS_SUB_SLOT - test_constants.NUM_SP_INTERVALS_EXTRA):
            sp = get_signage_point(test_constants, {}, None, uint128(0), uint8(i), [], peak.sub_slot_iters,)
        ...
        for i in range(
            sb.signage_point_index + test_constants.NUM_SP_INTERVALS_EXTRA, test_constants.NUM_SPS_SUB_SLOT,
        ):
