...
from flange.types.blockchain_format.program import Program, SerializedProgram

wallet_program_files = set(
    [
        "flange/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "flange/wallet/puzzles/cc.clvm",
        "flange/wallet/puzzles/flangelisp_deserialisation.clvm",
        "flange/wallet/puzzles/rom_bootstrap_generator.clvm",
        "flange/wallet/puzzles/generator_for_single_coin.clvm",
        "flange/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "flange/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "flange/wallet/puzzles/lock.inner.puzzle.clvm",
        "flange/wallet/puzzles/p2_conditions.clvm",
        "flange/wallet/puzzles/p2_delegated_conditions.clvm",
        "flange/wallet/puzzles/p2_delegated_puzzle.clvm",
        "flange/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "flange/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "flange/wallet/puzzles/p2_puzzle_hash.clvm",
        "flange/wallet/puzzles/rl_aggregation.clvm",
        "flange/wallet/puzzles/rl.clvm",
        "flange/wallet/puzzles/sha256tree_module.clvm",
        "flange/wallet/puzzles/singleton_top_layer.clvm",
        "flange/wallet/puzzles/did_innerpuz.clvm",
        "flange/wallet/puzzles/decompress_puzzle.clvm",
        "flange/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "flange/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "flange/wallet/puzzles/block_program_zero.clvm",
        "flange/wallet/puzzles/test_generator_deserialize.clvm",
        "flange/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "flange/wallet/puzzles/p2_singleton.clvm",
        "flange/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "flange/wallet/puzzles/pool_member_innerpuz.clvm",
        "flange/wallet/puzzles/singleton_launcher.clvm",
        "flange/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
    ]
)

clvm_include_files = set(
    ["flange/wallet/puzzles/create-lock-puzzlehash.clvm", "flange/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "flange/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to flange/wallet/puzzles, but not added to `wallet_program_files`
        """
