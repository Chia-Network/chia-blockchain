...
wallet_program_files = set(
    [
        ...
        "chinilla/wallet/puzzles/rl_aggregation.clvm",
        "chinilla/wallet/puzzles/rl.clvm",
        ...
        "chinilla/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "chinilla/wallet/puzzles/delegated_genesis_checker.clvm",
        "chinilla/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
    ]
)

clvm_include_files = set(
    ["chinilla/wallet/puzzles/create-lock-puzzlehash.clvm", "chinilla/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "chinilla/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to chinilla/wallet/puzzles, but not added to `wallet_program_files`
        """
