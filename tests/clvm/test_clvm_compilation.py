...
wallet_program_files = set(
    [
        ...
        "chia/wallet/puzzles/dao_proposal_validator.clvm",
        "chia/wallet/puzzles/genesis_by_coin_id_or_singleton.clvm",
        "chia/wallet/puzzles/dao_spend_p2_singleton.clvm",
        "chia/wallet/puzzles/dao_spend_p2_singleton_v2.clvm",
    ]
)
