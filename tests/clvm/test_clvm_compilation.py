...
wallet_program_files = set(
    [
        "shitcoin/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "shitcoin/wallet/puzzles/cc.clvm",
        "shitcoin/wallet/puzzles/shitcoinlisp_deserialisation.clvm",
        "shitcoin/wallet/puzzles/rom_bootstrap_generator.clvm",
        "shitcoin/wallet/puzzles/generator_for_single_coin.clvm",
        "shitcoin/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "shitcoin/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "shitcoin/wallet/puzzles/lock.inner.puzzle.clvm",
        "shitcoin/wallet/puzzles/p2_conditions.clvm",
        "shitcoin/wallet/puzzles/p2_delegated_conditions.clvm",
        "shitcoin/wallet/puzzles/p2_delegated_puzzle.clvm",
        "shitcoin/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "shitcoin/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "shitcoin/wallet/puzzles/p2_puzzle_hash.clvm",
        "shitcoin/wallet/puzzles/rl_aggregation.clvm",
        "shitcoin/wallet/puzzles/rl.clvm",
        "shitcoin/wallet/puzzles/sha256tree_module.clvm",
        "shitcoin/wallet/puzzles/singleton_top_layer.clvm",
        "shitcoin/wallet/puzzles/did_innerpuz.clvm",
        "shitcoin/wallet/puzzles/decompress_puzzle.clvm",
        "shitcoin/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "shitcoin/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "shitcoin/wallet/puzzles/block_program_zero.clvm",
        "shitcoin/wallet/puzzles/test_generator_deserialize.clvm",
        "shitcoin/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "shitcoin/wallet/puzzles/p2_singleton.clvm",
        "shitcoin/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "shitcoin/wallet/puzzles/pool_member_innerpuz.clvm",
        "shitcoin/wallet/puzzles/singleton_launcher.clvm",
        "shitcoin/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
    ]
)

clvm_include_files = set(
    ["shitcoin/wallet/puzzles/create-lock-puzzlehash.clvm", "shitcoin/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "shitcoin/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to shitcoin/wallet/puzzles, but not added to `wallet_program_files`
        """
