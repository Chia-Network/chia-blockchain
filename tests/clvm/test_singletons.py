...
class TestSingleton:
    ...
    async def test_singleton_top_layer(self):
        ...
        # EVE
        singleton_eve: Coin = node.all_non_reward_coins()[0]
        ...
        # POST-EVE
        singleton: Coin = node.all_non_reward_coins()[0]
        ...
        evil_coin: Coin = node.all_non_reward_coins()[0]
        delegated_puzzle: Program = Program.to(
            (
                1,
                [
        ...
        melted_coin: Coin = node.all_non_reward_coins()[0]
