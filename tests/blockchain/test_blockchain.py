...
class TestBodyValidation:
    ...
    @pytest.mark.parametrize("with_garbage,expected", [(True, ReceiveBlockResult.INVALID_BLOCK), (False, ReceiveBlockResult.NEW_PEAK)])
    async def test_aggsig_garbage(self, empty_blockchain, opcode, with_garbage, expected):
        ...
        print(f"secret key: {synthetic_secret_key}")
