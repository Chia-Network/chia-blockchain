...
from shitcoin.consensus.condition_costs import ConditionCost
...
from shitcoin.full_node.mempool_check_conditions import get_name_puzzle_conditions, get_puzzle_and_solution_for_coin
...
from shitcoin.wallet.puzzles import p2_delegated_puzzle_or_hidden_puzzle
...
def large_block_generator(size):
    ...
    try:
        ...
        #  TODO: Re-enable large-block*.hex but cache in ~/.shitcoin/subdir
