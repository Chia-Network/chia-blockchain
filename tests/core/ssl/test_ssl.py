...
class TestSSL:
    ...
    async def test_farmer(self, harvester_farmer):
        ...
        ssl_context = ssl_context_for_client(
            farmer_server.tad_ca_crt_path, farmer_server.tad_ca_crt_path, pub_crt, pub_key
        )
        connected = await establish_connection(farmer_server, 12312, ssl_context)
    ...
    async def test_full_node(self, wallet_node):
        ...
        ssl_context = ssl_context_for_client(
            full_node_server.tad_ca_crt_path, full_node_server.tad_ca_crt_path, pub_crt, pub_key
        )
    ...
    async def test_wallet(self, wallet_node):
        ...
        ssl_context = ssl_context_for_client(
            wallet_server.tad_ca_crt_path, wallet_server.tad_ca_crt_path, pub_crt, pub_key
        )
    ...
    async def test_harvester(self, harvester_farmer):
        ...
        ssl_context = ssl_context_for_client(
            harvester_server.tad_ca_crt_path, harvester_server.tad_ca_crt_path, pub_crt, pub_key
        )
    ...
    async def test_introducer(self, introducer):
        ...
        ssl_context = ssl_context_for_client(
            introducer_server.tad_ca_crt_path, introducer_server.tad_ca_crt_path, pub_crt, pub_key
        )
    ...
    async def test_timelord(self, timelord):
        ...
        ssl_context = ssl_context_for_client(
            timelord_server.tad_ca_crt_path, timelord_server.tad_ca_crt_path, pub_crt, pub_key
        )
