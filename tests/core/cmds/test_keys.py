...
def test_generate_with_new_config(tmp_path, empty_keyring):
    """
...
def test_generate_with_existing_config(tmp_path, empty_keyring):
    """
...
def test_generate_and_add_label_parameter(
    cmd_params: List[str], label: Optional[str], input_str: Optional[str], tmp_path, empty_keyring
):
    keychain = empty_keyring
    keys_root_path = keychain.keyring_wrapper.keys_root_path
    base_params = [
...
def test_set_label(keyring_with_one_key, tmp_path):
...
def test_delete_label(keyring_with_one_key, tmp_path):
    keychain = keyring_with_one_key
    keys_root_path = keychain.keyring_wrapper.keys_root_path
    base_params = [
        "--root-path",
...
def test_show_labels(empty_keyring, tmp_path):
    keychain = empty_keyring
    runner = CliRunner()
    keys_root_path = keychain.keyring_wrapper.keys_root_path
    base_params = [
...
def test_show(keyring_with_one_key, tmp_path):
    """
...
def test_show_fingerprint(keyring_with_one_key, tmp_path):
    """
...
def test_show_json(keyring_with_one_key, tmp_path):
    """
...
def test_show_mnemonic(keyring_with_one_key, tmp_path):
    """
...
def test_show_mnemonic_json(keyring_with_one_key, tmp_path):
    """
...
def test_add_interactive(tmp_path, empty_keyring):
    """
...
def test_add_from_mnemonic_seed(tmp_path, empty_keyring, mnemonic_seed_file):
    """
...
def test_delete(tmp_path, empty_keyring, mnemonic_seed_file):
    """
...
def test_delete_all(empty_keyring):
    """
...
def test_sign(keyring_with_one_key):
    """
...
def test_sign_non_observer(keyring_with_one_key):
    """
...
def test_sign_mnemonic_seed_file(empty_keyring, mnemonic_seed_file):
    """
...
def test_derive_search(tmp_path, keyring_with_one_key):
    """
...
def test_derive_search_wallet_address(tmp_path, keyring_with_one_key):
    """
...
def test_derive_search_wallet_testnet_address(tmp_path, keyring_with_one_key):
    """
...
def test_derive_search_failure(tmp_path, keyring_with_one_key):
    """
...
def test_derive_search_hd_path(tmp_path, empty_keyring, mnemonic_seed_file):
    """
...
def test_derive_wallet_address(tmp_path, keyring_with_one_key):
    """
...
def test_derive_wallet_testnet_address(tmp_path, keyring_with_one_key):
    """
...
def test_derive_child_keys(tmp_path, keyring_with_one_key):
    """
