...
from chinilla.util.config import create_default_chinilla_config, initial_config_file, load_config, save_config
...
class TestConfig:
    ...
    def test_load_config(self, root_path_populated_with_config, default_config_dict):
        ...
        assert config["daemon_port"] == default_config_dict["daemon_port"] == 42400
        ...
        assert (
            ...
            == "57885b6b6c35647f7e3fe0a001d18be61a4a587f84215094ad93836d48299a56"
        )
