...
@pytest_asyncio.fixture(name="populated_offer_setup")
async def populated_offer_setup_fixture(offer_setup: OfferSetup) -> OfferSetup:
    return await populate_offer_setup(offer_setup=offer_setup, count=10)
...
make_one_take_one_reference = MakeAndTakeReference(
    ...
    maker_root_history=[bytes32.from_hexstr("8e54f5066aa7999fc1561a56df59d11ff01f7df93cadf49a61adebf65dec65ea")],
    taker_root_history=[bytes32.from_hexstr("eeb63ac765065d2ee161e1c059c8188ef809e1c3ed8739bad5bfee2c2ee1c742")],
)
...
make_two_take_one_reference = MakeAndTakeReference(
    ...
    maker_root_history=[bytes32.from_hexstr("043fed6d67961e36db2900b6aab24aa68be529c4e632aace486fbea1b26dc70e")],
    taker_root_history=[bytes32.from_hexstr("eeb63ac765065d2ee161e1c059c8188ef809e1c3ed8739bad5bfee2c2ee1c742")],
)
...
make_one_take_two_reference = MakeAndTakeReference(
    ...
    maker_root_history=[bytes32.from_hexstr("8e54f5066aa7999fc1561a56df59d11ff01f7df93cadf49a61adebf65dec65ea")],
    taker_root_history=[bytes32.from_hexstr("2215da3c9a309e0d8972fd6acb8ac62898a0f7e4a07351d558c2cc5094dfc5ec")],
)
...
make_one_upsert_take_one_reference = MakeAndTakeReference(
    ...
    maker_root_history=[bytes32.from_hexstr("3761921b9b0520458995bb0ec353ea28d36efa2a7cfc3aba6772f005f7dd34c6")],
    taker_root_history=[bytes32.from_hexstr("eeb63ac765065d2ee161e1c059c8188ef809e1c3ed8739bad5bfee2c2ee1c742")],
)
...
make_one_take_one_upsert_reference = MakeAndTakeReference(
    ...
    maker_root_history=[bytes32.from_hexstr("8e54f5066aa7999fc1561a56df59d11ff01f7df93cadf49a61adebf65dec65ea")],
    taker_root_history=[bytes32.from_hexstr("d77afd64e9f307f3250a352c155480311512f9da2033228f1a2f0a3687cc90e0")],
)
...
@pytest.mark.asyncio
async def test_make_and_take_offer(populated_offer_setup: OfferSetup, reference: MakeAndTakeReference) -> None:
    offer_setup = populated_offer_setup
    maker_request = {
        "maker": [
            {
...
@pytest.mark.parametrize(
    argnames="reference",
    argvalues=[
        pytest.param(make_one_take_one_unpopulated_reference, id="one for one"),
    ],
)
@pytest.mark.asyncio
async def test_make_and_take_offer_unpopulated(offer_setup: OfferSetup, reference: MakeAndTakeReference) -> None:
    maker_request = {
        "maker": [
            {
                "store_id": offer_setup.maker.id.hex(),
