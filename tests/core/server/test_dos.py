...
@pytest.mark.asyncio
async def test_large_message_disconnect_and_ban(setup_two_nodes_fixture, self_hostname):
    ...
    ws = await session.ws_connect(url, autoclose=True, autoping=True, ssl=ssl_context, max_msg_size=100 * 1024 * 1024)
...
@pytest.mark.asyncio
async def test_bad_handshake_and_ban(setup_two_nodes_fixture, self_hostname):
    nodes, _, _ = setup_two_nodes_fixture
    server_1 = nodes[0].full_node.server
    server_2 = nodes[1].full_node.server
...
@pytest.mark.asyncio
async def test_invalid_protocol_handshake(setup_two_nodes_fixture, self_hostname):
    nodes, _, _ = setup_two_nodes_fixture
    server_1 = nodes[0].full_node.server
    server_2 = nodes[1].full_node.server
...
@pytest.mark.asyncio
async def test_spam_tx(setup_two_nodes_fixture, self_hostname):
    nodes, _, _ = setup_two_nodes_fixture
...
@pytest.mark.asyncio
async def test_spam_message_non_tx(setup_two_nodes_fixture, self_hostname):
    nodes, _, _ = setup_two_nodes_fixture
    full_node_1, full_node_2 = nodes
    server_1 = nodes[0].full_node.server
    server_2 = nodes[1].full_node.server
...
@pytest.mark.asyncio
async def test_spam_message_too_large(setup_two_nodes_fixture, self_hostname):
    nodes, _, _ = setup_two_nodes_fixture
    full_node_1, full_node_2 = nodes
    server_1 = nodes[0].full_node.server
    server_2 = nodes[1].full_node.server
