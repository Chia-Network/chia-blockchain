...
from tests.setup_nodes import setup_simulators_and_wallets, bt, SimulatorsAndWallets
...
class TestFilter:
    ...
    async def wallet_and_node(self) -> AsyncIterator[SimulatorsAndWallets]:
        async for _ in setup_simulators_and_wallets(1, 1, {}):
            yield _

    @pytest.mark.asyncio
    async def test_basic_filter_test(self, wallet_and_node: SimulatorsAndWallets):
