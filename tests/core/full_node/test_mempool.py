...
from shitcoin.util.condition_tools import conditions_for_solution, pkm_pairs
...
from shitcoin.util.api_decorators import api_request, peer_required, bytes_required
