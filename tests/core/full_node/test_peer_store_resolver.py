...
def test_resolve_unmodified_legacy_peer_db_path(tmp_path: Path):
    """
...
def test_resolve_modified_legacy_peer_db_path(tmp_path: Path):
    """
...
def test_resolve_default_peers_file_path(tmp_path: Path):
    """
...
def test_resolve_modified_peers_file_path(tmp_path: Path):
    """
...
def test_resolve_both_peers_file_path_and_legacy_peer_db_path_exist(tmp_path: Path):
    """
...
def test_resolve_modified_both_peers_file_path_and_legacy_peer_db_path_exist(tmp_path: Path):
    """
...
def test_resolve_missing_keys(tmp_path: Path):
    """
...
def test_resolve_with_testnet(tmp_path: Path):
    """
...
def test_resolve_default_legacy_db_path(tmp_path: Path):
    """
