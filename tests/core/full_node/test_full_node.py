...
@pytest.mark.asyncio
async def test_new_transaction_and_mempool(wallet_nodes, self_hostname):
    full_node_1, full_node_2, server_1, server_2, wallet_a, wallet_receiver, bt = wallet_nodes
...
@pytest.mark.asyncio
async def test_request_respond_transaction(wallet_nodes, self_hostname):
    full_node_1, full_node_2, server_1, server_2, wallet_a, wallet_receiver, bt = wallet_nodes
    wallet_ph = wallet_a.get_new_puzzlehash()
    blocks = await full_node_1.get_all_full_blocks()
...
@pytest.mark.asyncio
async def test_respond_transaction_fail(wallet_nodes, self_hostname):
    full_node_1, full_node_2, server_1, server_2, wallet_a, wallet_receiver, bt = wallet_nodes
    blocks = await full_node_1.get_all_full_blocks()
...
@pytest.mark.asyncio
async def test_new_unfinished_block(wallet_nodes, self_hostname):
    full_node_1, full_node_2, server_1, server_2, wallet_a, wallet_receiver, bt = wallet_nodes
    blocks = await full_node_1.get_all_full_blocks()
