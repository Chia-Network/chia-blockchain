...
@pytest.mark.asyncio
async def test_addr_manager_ports():
    addrman = AddressManagerTest()
    assert await addrman.size() == 0
...
@pytest.mark.asyncio
async def test_addrman_collisions_new():
    addrman = AddressManagerTest()
    assert await addrman.size() == 0
    source = PeerInfo("252.2.2.2", 8444)
...
@pytest.mark.asyncio
async def test_addrman_collisions_tried():
    addrman = AddressManagerTest()
    assert await addrman.size() == 0
    source = PeerInfo("252.2.2.2", 8444)
...
@pytest.mark.asyncio
async def test_addrman_get_peers():
    addrman = AddressManagerTest()
    assert await addrman.size() == 0
...
@pytest.mark.asyncio
async def test_addrman_tried_bucket():
    peer1 = PeerInfo("250.1.1.1", 8444)
...
@pytest.mark.asyncio
async def test_addrman_new_bucket():
...
@pytest.mark.asyncio
async def test_addrman_select_collision_no_collision():
    addrman = AddressManagerTest()
...
@pytest.mark.asyncio
async def test_addrman_no_evict():
    addrman = AddressManagerTest()
...
@pytest.mark.asyncio
async def test_addrman_eviction_works():
    addrman = AddressManagerTest()
    assert await addrman.size() == 0
...
async def test_serialization(tmp_path: Path):
    addrman = AddressManagerTest()
