...
from flange.server.server import ssl_context_for_server
from flange.types.peer_info import PeerInfo
from tests.block_tools import BlockTools
from flange.util.ints import uint16
from flange.util.ws_message import create_payload
...
class TestDaemon:
    ...
    async def test_daemon_simulation(self, simulation, get_daemon):
        ...
        data = {}
        payload = create_payload("get_blockchain_state", data, service_name, "flange_full_node")
        await ws.send_str(payload)
