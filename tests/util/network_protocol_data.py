...
module_to_name_to_instance: InstanceProtocolData = {
    ...
    "wallet_protocol": {
        ...
        "respond_removals": wallet_protocol.RespondRemovals(
            ...
            [
                (
                    bytes32(bytes.fromhex("652c312e1dd9f32bf074e17ae8b658bf47711bd1a5e6c937adfb0c80b51fa49d")),
                    bytes(b"a" * 10),
                )
            ],
        ),
        ...
        "respond_additions": wallet_protocol.RespondAdditions(
            ...
            [
                (
                    bytes32(bytes.fromhex("ed8daaf9233ed82e773ef4d1e89f2958fec0570137cf2c267ae22099ab43a9a4")),
                    [coin_1, coin_1],
                )
            ],
            [
