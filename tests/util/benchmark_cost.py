...
from flange.types.blockchain_format.program import Program, INFINITE_COST
...
from flange.wallet.puzzles.p2_delegated_puzzle import puzzle_for_pk
...
def run_and_return_cost_time(flangelisp):
    ...
    clvm_loop_solution = f"(1000 {flangelisp})"
