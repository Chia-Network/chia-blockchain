...
from shitcoin.types.blockchain_format.program import Program, INFINITE_COST
...
from shitcoin.wallet.derive_keys import master_sk_to_wallet_sk
from shitcoin.wallet.puzzles.p2_delegated_puzzle import puzzle_for_pk
...
def run_and_return_cost_time(shitcoinlisp):
    ...
    clvm_loop_solution = f"(1000 {shitcoinlisp})"
