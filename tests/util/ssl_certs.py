...
from tests.util.ssl_certs_1 import SSL_TEST_PRIVATE_CA_CERT_AND_KEY_1, SSL_TEST_NODE_CERTS_AND_KEYS_1
from tests.util.ssl_certs_2 import SSL_TEST_PRIVATE_CA_CERT_AND_KEY_2, SSL_TEST_NODE_CERTS_AND_KEYS_2
from tests.util.ssl_certs_3 import SSL_TEST_PRIVATE_CA_CERT_AND_KEY_3, SSL_TEST_NODE_CERTS_AND_KEYS_3
from tests.util.ssl_certs_4 import SSL_TEST_PRIVATE_CA_CERT_AND_KEY_4, SSL_TEST_NODE_CERTS_AND_KEYS_4
from tests.util.ssl_certs_5 import SSL_TEST_PRIVATE_CA_CERT_AND_KEY_5, SSL_TEST_NODE_CERTS_AND_KEYS_5
from tests.util.ssl_certs_6 import SSL_TEST_PRIVATE_CA_CERT_AND_KEY_6, SSL_TEST_NODE_CERTS_AND_KEYS_6
from tests.util.ssl_certs_7 import SSL_TEST_PRIVATE_CA_CERT_AND_KEY_7, SSL_TEST_NODE_CERTS_AND_KEYS_7
