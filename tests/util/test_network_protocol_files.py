...
def test_protocol_bytes() -> None:
    ...
    message_bytes = input_bytes["new_signage_point"]
    ...
    message_bytes = input_bytes["declare_proof_of_space"]
    ...
    message_bytes = input_bytes["request_signed_values"]
    ...
    message_bytes = input_bytes["request_transaction"]
    ...
    message_bytes = input_bytes["respond_transaction"]
    ...
    message_bytes = input_bytes["request_proof_of_weight"]
    ...
    message_bytes = input_bytes["respond_proof_of_weight"]
    ...
    message_bytes = input_bytes["respond_blocks"]
    ...
    message_bytes = input_bytes["request_unfinished_block"]
    ...
    message_bytes = input_bytes["respond_unfinished_block"]
    ...
    message_bytes = input_bytes["new_signage_point_or_end_of_subslot"]
    ...
    message_bytes = input_bytes["request_signage_point_or_end_of_subslot"]
    ...
    message_bytes = input_bytes["respond_signage_point"]
    ...
    message_bytes = input_bytes["respond_end_of_subslot"]
    ...
    message_bytes = input_bytes["request_mempool_transaction"]
    ...
    message_bytes = input_bytes["new_compact_vdf"]
    ...
    message_bytes = input_bytes["request_compact_vdf"]
    ...
    message_bytes = input_bytes["respond_compact_vdf"]
    ...
    message_bytes = input_bytes["puzzle_solution_response"]
    ...
    message_bytes = input_bytes["respond_puzzle_solution"]
    ...
    message_bytes = input_bytes["reject_puzzle_solution"]
    ...
    message_bytes = input_bytes["send_transaction"]
    ...
    message_bytes = input_bytes["transaction_ack"]
    ...
    message_bytes = input_bytes["new_peak_wallet"]
    ...
    message_bytes = input_bytes["request_block_header"]
    ...
    message_bytes = input_bytes["respond_header_block"]
    ...
    message_bytes = input_bytes["reject_header_request"]
    ...
    message_bytes = input_bytes["request_removals"]
    ...
    message_bytes = input_bytes["respond_removals"]
    ...
    message_bytes = input_bytes["reject_removals_request"]
    ...
    message_bytes = input_bytes["request_additions"]
    ...
    message_bytes = input_bytes["respond_additions"]
    ...
    message_bytes = input_bytes["reject_additions"]
    ...
    message_bytes = input_bytes["request_header_blocks"]
    ...
    message_bytes = input_bytes["reject_header_blocks"]
    ...
    message_bytes = input_bytes["respond_header_blocks"]
    ...
    message_bytes = input_bytes["respond_to_ph_updates"]
    ...
    message_bytes = input_bytes["register_for_coin_updates"]
    ...
    message_bytes = input_bytes["respond_to_coin_updates"]
    ...
    message_bytes = input_bytes["coin_state_update"]
    ...
    message_bytes = input_bytes["request_children"]
    ...
    message_bytes = input_bytes["respond_children"]
    ...
    message_bytes = input_bytes["request_ses_info"]
    ...
    message_bytes = input_bytes["respond_ses_info"]
    ...
    message_bytes = input_bytes["pool_difficulty"]
    ...
    message_bytes = input_bytes["harvester_handhsake"]
    ...
    message_bytes = input_bytes["new_signage_point_harvester"]
    ...
    message_bytes = input_bytes["new_proof_of_space"]
    ...
    message_bytes = input_bytes["request_signatures"]
    ...
    message_bytes = input_bytes["respond_signatures"]
    ...
    message_bytes = input_bytes["respond_peers_introducer"]
    ...
    message_bytes = input_bytes["authentication_payload"]
    ...
    message_bytes = input_bytes["get_pool_info_response"]
    ...
    message_bytes = input_bytes["post_partial_payload"]
    ...
    message_bytes = input_bytes["post_partial_request"]
    ...
    message_bytes = input_bytes["post_partial_response"]
    ...
    message_bytes = input_bytes["get_farmer_response"]
    ...
    message_bytes = input_bytes["post_farmer_payload"]
    ...
    message_bytes = input_bytes["post_farmer_request"]
    ...
    message_bytes = input_bytes["post_farmer_response"]
    ...
    message_bytes = input_bytes["put_farmer_payload"]
    ...
    message_bytes = input_bytes["put_farmer_request"]
    ...
    message_bytes = input_bytes["put_farmer_response"]
    ...
    message_bytes = input_bytes["error_response"]
    ...
    message_bytes = input_bytes["new_peak_timelord"]
    ...
    message_bytes = input_bytes["new_unfinished_block_timelord"]
    ...
    message_bytes = input_bytes["new_infusion_point_vdf"]
    ...
    message_bytes = input_bytes["new_signage_point_vdf"]
    ...
    message_bytes = input_bytes["new_end_of_sub_slot_bundle"]
    ...
    message_bytes = input_bytes["request_compact_proof_of_time"]
    ...
    message_bytes = input_bytes["respond_compact_proof_of_time"]
