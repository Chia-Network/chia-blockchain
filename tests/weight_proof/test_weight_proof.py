...
from tad.server.start_full_node import SERVICE_NAME
...
from tad.consensus.pot_iterations import calculate_iterations_quality
from tad.full_node.weight_proof import (  # type: ignore
    WeightProofHandler,
