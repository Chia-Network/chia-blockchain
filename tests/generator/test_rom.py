...
from shitcoin.full_node.generator import run_generator
...
DESERIALIZE_MOD = load_clvm("shitcoinlisp_deserialisation.clvm", package_or_requirement="shitcoin.wallet.puzzles")
