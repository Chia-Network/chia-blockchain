...
#
# from chia.pools.pool_puzzles import POOL_MEMBER_HASH, P2_SINGLETON_HASH, POOL_WAITING_ROOM_HASH
...
#         self.generate_signed_transaction = Wallet.generate_signed_transaction  # type: ignore
#         return self
#
...
#         new_wallet_info = WalletInfo(uint32(id), name, uint8(wallet_type), data)
...
#             POOL_WAITING_ROOM_HASH: Coin(escaping_parent, POOL_WAITING_ROOM_HASH, 1),
...
#
#         index = 1
#         puzzlehash: bytes32 = bytes32(b"\x03" * 32)
...
#             [PoolSingletonState.PENDING_CREATION, short_puzzlehash, None, good_relative_lock_height],
#             [PoolSingletonState.PENDING_CREATION, long_puzzlehash, None, good_relative_lock_height],
...
#         owner_pubkey = 0xFADEDDAB
#
#         initial_pending_state = create_pool_state(PoolSingletonState.PENDING_CREATION, rewards_puzzlehash, None, 1)
#         initial_pooling_state = create_pool_state(
#             PoolSingletonState.FARMING_TO_POOL, pool_puzzlehash, pool_url, relative_lock_height
#         )
#         initial_self_pooling_state = create_pool_state(PoolSingletonState.SELF_POOLING, rewards_puzzlehash, None, 0)
