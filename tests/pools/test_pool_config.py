...
from tad.pools.pool_config import PoolWalletConfig
from tad.util.config import load_config, save_config, create_default_tad_config
...
def test_pool_config():
    ...
    create_default_tad_config(test_root, ["config.yaml"])
