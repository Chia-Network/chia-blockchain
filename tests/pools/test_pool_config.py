...
def test_pool_config():
    ...
    d = {
        "owner_public_key": "b6509da7ddb76adacdffd9c93145a585f07e8976d9d5b1f575d82fdafda2e2f0dd66fa22589ca344d95ee9d44cf51c74",  # noqa
        ...
        "pool_payout_instructions_signature": "95ae82302134489d68cf0890356fc2d360c3bda9c9f15a3111a6a776df073a2fc6194896f3196a10fba18bb9de8e4fae0caf08e49fe32786d35fe0538daf0ceb6f7ace9477440b9978589bcaa28690dded6e5a296b47bffe2db97c1c28c9d13c",  # noqa
    }

    pwc = PoolWalletConfig(
        hexstr_to_bytes(d["owner_public_key"]),
        hexstr_to_bytes(d["target_puzzle_hash"]),
        d["pool_url"],
        hexstr_to_bytes(d["singleton_genesis"]),
        hexstr_to_bytes(d["pool_payout_instructions"]),
        hexstr_to_bytes(d["pool_payout_instructions_signature"]),
    )
    ...
    config_aa = load_config(test_root, "test_pool_config_a.yaml")
    config_bb = load_config(test_root, "test_pool_config_b.yaml")

    assert config_aa == config_bb
