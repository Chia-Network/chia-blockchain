...
from flange.pools.pool_config import PoolWalletConfig
from flange.util.config import load_config, save_config, create_default_flange_config
...
def test_pool_config():
    ...
    create_default_flange_config(test_root, ["config.yaml"])
