...
from shitcoin.pools.pool_config import PoolWalletConfig
from shitcoin.util.config import load_config, save_config, create_default_shitcoin_config
...
def test_pool_config():
    ...
    create_default_shitcoin_config(test_root, ["config.yaml"])
