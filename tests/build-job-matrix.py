...
for path in test_paths:
    ...
    process_count = {
        "macos": {False: 0, True: 40}.get(conf["parallel"], conf["parallel"]),
        "ubuntu": {False: 0, True: 40}.get(conf["parallel"], conf["parallel"]),
        "windows": {False: 0, True: 40}.get(conf["parallel"], conf["parallel"]),
    }
