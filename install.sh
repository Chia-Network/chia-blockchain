...
if [ "$(uname -m)" = "armv7l" ]; then
  echo ""
	echo "WARNING:"
	echo "The Sector Blockchain requires a 64 bit OS and this is 32 bit armv7l"
...
echo ""
echo "Sector blockchain install.sh complete."
...
echo "https://github.com/Sector-Network/sector-blockchain/wiki/Quick-Start-Guide"
echo ""
