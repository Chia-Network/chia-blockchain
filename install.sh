...
# e.g. `export INSTALL_PYTHON_VERSION=3.11`
INSTALL_PYTHON_PATH=
PYTHON_MAJOR_VER=
PYTHON_MINOR_VER=
SQLITE_VERSION=
...
find_python() {
  set +e
  unset BEST_VERSION
  for V in 314 3.14 313 3.13 312 3.12 311 3.11 3; do
...
if [ "$PYTHON_MAJOR_VER" -ne "3" ] || [ "$PYTHON_MINOR_VER" -lt "11" ] || [ "$PYTHON_MINOR_VER" -ge "15" ]; then
  echo "Chia requires Python version >= 3.11 and < 3.15.0" >&2
