...
if [ "$(uname -m)" = "armv7l" ]; then
  echo ""
	echo "WARNING:"
	echo "The shitcoin Blockchain requires a 64 bit OS and this is 32 bit armv7l"
	echo "For more information, see"
	echo "https://github.com/shitcoin-Network/shitcoin-blockchain/wiki/Raspberry-Pi"
	echo "Exiting."
	exit 1
fi
# Get submodules
...
python -m pip install --extra-index-url https://pypi.shitcoin.net/simple/ miniupnpc==2.2.2
python -m pip install -e . --extra-index-url https://pypi.shitcoin.net/simple/

echo ""
echo "shitcoin blockchain install.sh complete."
echo "For assistance join us on Keybase in the #support chat channel:"
echo "https://keybase.io/team/shitcoin_network.public"
echo ""
echo "Try the Quick Start Guide to running shitcoin-blockchain:"
echo "https://github.com/shitcoin-Network/shitcoin-blockchain/wiki/Quick-Start-Guide"
echo ""
echo "To install the GUI type 'sh install-gui.sh' after '. ./activate'."
echo ""
echo "Type '. ./activate' and then 'shitcoin init' to begin."
