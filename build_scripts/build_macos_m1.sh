...
if [ "$NOTARIZE" ]; then
  electron-osx-sign Flange-darwin-arm64/Flange.app --platform=darwin \
...
mv Flange-darwin-arm64 ../build_scripts/dist/
cd ../build_scripts || exit

DMG_NAME="Flange-$CHIA_INSTALLER_VERSION-arm64.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Flange-darwin-arm64/Flange.app Flange-$CHIA_INSTALLER_VERSION-arm64 \
