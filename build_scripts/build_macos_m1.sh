...
if [ "$NOTARIZE" ]; then
  electron-osx-sign Chinilla-darwin-arm64/Chinilla.app --platform=darwin \
  --hardened-runtime=true --provisioning-profile=chinillablockchain.provisionprofile \
...
mv Chinilla-darwin-arm64 ../../../build_scripts/dist/
cd ../../../build_scripts || exit

DMG_NAME="Chinilla-$CHINILLA_INSTALLER_VERSION-arm64.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Chinilla-darwin-arm64/Chinilla.app Chinilla-$CHINILLA_INSTALLER_VERSION-arm64 \
...
# xcrun stapler staple Chinilla-0.1.X.dmg
#
# Validate DMG:
# xcrun stapler validate Chinilla-0.1.X.dmg
