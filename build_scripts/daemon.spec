...
full_node = Analysis(
    [path_for_file("src.server.start_full_node")],
    pathex=[path_for_file("aiter"), f"{root}"],
    binaries=[],
    datas=[version_data],
    hiddenimports=hiddenimports,
...
wallet = Analysis(
    [path_for_file("src.server.start_wallet")],
    pathex=[path_for_file("aiter"), f"{root}"],
    binaries=[],
    datas=[
...
farmer = Analysis(
    [path_for_file("src.server.start_farmer")],
    pathex=[path_for_file("aiter"), f"{root}"],
    binaries=[],
    datas=[version_data],
    hiddenimports=hiddenimports,
...
harvester = Analysis(
    [path_for_file("src.server.start_harvester")],
    pathex=[path_for_file("aiter"), f"{root}"],
    binaries=[],
    datas=[version_data],
    hiddenimports=hiddenimports,
