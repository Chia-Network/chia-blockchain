...
dependencies = [
    ...
    "aiosqlite@git+https://github.com/mariano54/aiosqlite.git@ea281b81bb59e50d73cc5ec3763625305c2ea908#egg=aiosqlite",  # asyncio wrapper for sqlite, to store blocks
