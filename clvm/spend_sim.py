...
from shitcoin.consensus.coinbase import create_pool_coin, create_farmer_coin
...
"""
The purpose of this file is to provide a lightweight simulator for the testing of shitcoinlisp smart contracts.
...
There is also a provided NodeClient object which implements many of the methods from shitcoin.rpc.full_node_rpc_client
