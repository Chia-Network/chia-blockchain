...
def generate_and_print():
    ...
    print(mnemonic)
    print("Note that this key has not been added to the keychain. Run chives keys add")
    return mnemonic
...
def show_all_keys(show_mnemonic: bool):
    ...
    for sk, seed in private_keys:
        ...
        print(
            "Farmer puzzle hash (m/12381/8444/0/0):",
        ...
        print("Pool puzzle hash (m/12381/8444/1/0):", create_puzzlehash_for_pk(master_sk_to_pool_sk(sk).get_g1()))
