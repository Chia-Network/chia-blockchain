...
from chives.consensus.pos_quality import UI_ACTUAL_SPACE_CONSTANT_FACTOR
...
class FullNodeRpcApi:
    def __init__(self, service: FullNode):
        ...
        self.service_name = "chives_full_node"
    ...
    async def get_blockchain_state(self, _request: Dict):
        ...
        self.service.log.warning(f"is_connected:{is_connected}")
        self.service.log.warning(f"synced:{synced}")
